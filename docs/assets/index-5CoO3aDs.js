...
`)+`
`+m);const x=S+p+a,E=S+m+o,w=dc(i,i.VERTEX_SHADER,x),b=dc(i,i.FRAGMENT_SHADER,E);i.attachShader(_,w),i.attachShader(_,b),e.index0AttributeName!==void 0?i.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function T(C){if(r.debug.checkShaderErrors){const D=i.getProgramInfoLog(_).trim(),I=i.getShaderInfoLog(w).trim(),N=i.getShaderInfoLog(b).trim();let k=!0,O=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(k=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,w,b);else{const G=pc(i,w,"vertex"),z=pc(i,b,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
Program Info Log: `+D+`
`+G+`
`+z)}else D!==""?console.warn("THREE.WebGLProgram: Program Info Log:",D):(I===""||N==="")&&(O=!1);O&&(C.diagnostics={runnable:k,programLog:D,vertexShader:{log:I,prefix:p},fragmentShader:{log:N,prefix:m}})}i.deleteShader(w),i.deleteShader(b),P=new Cs(i,_),y=cg(i,_)}let P;this.getUniforms=function(){return P===void 0&&T(this),P};let y;this.getAttributes=function(){return y===void 0&&T(this),y};let M=e.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return M===!1&&(M=i.getProgramParameter(_,eg)),M},this.destroy=function(){n.releaseStatesOfProgram(this),i.deleteProgram(_),this.program=void 0},this.type=e.shaderType,this.name=e.shaderName,this.id=ng++,this.cacheKey=t,this.usedTimes=1,this.program=_,this.vertexShader=w,this.fragmentShader=b,this}let Sg=0;class yg{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(t){const e=t.vertexShader,n=t.fragmentShader,i=this._getShaderStage(e),s=this._getShaderStage(n),a=this._getShaderCacheForMaterial(t);return a.has(i)===!1&&(a.add(i),i.usedTimes++),a.has(s)===!1&&(a.add(s),s.usedTimes++),this}remove(t){const e=this.materialCache.get(t);for(const n of e)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(t),this}getVertexShaderID(t){return this._getShaderStage(t.vertexShader).id}getFragmentShaderID(t){return this._getShaderStage(t.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(t){const e=this.materialCache;let n=e.get(t);return n===void 0&&(n=new Set,e.set(t,n)),n}_getShaderStage(t){const e=this.shaderCache;let n=e.get(t);return n===void 0&&(n=new Eg(t),e.set(t,n)),n}}class Eg{constructor(t){this.id=Sg++,this.code=t,this.usedTimes=0}}function Tg(r,t,e,n,i,s,a){const o=new _u,l=new yg,c=new Set,u=[],h=i.logarithmicDepthBuffer,f=i.vertexTextures;let d=i.precision;const g={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function _(y){return c.add(y),y===0?"uv":`uv${y}`}function p(y,M,C,D,I){const N=D.fog,k=I.geometry,O=y.isMeshStandardMaterial?D.environment:null,G=(y.isMeshStandardMaterial?e:t).get(y.envMap||O),z=G&&G.mapping===$s?G.image.height:null,et=g[y.type];y.precision!==null&&(d=i.getMaxPrecision(y.precision),d!==y.precision&&console.warn("THREE.WebGLProgram.getParameters:",y.precision,"not supported, using",d,"instead."));const nt=k.morphAttributes.position||k.morphAttributes.normal||k.morphAttributes.color,lt=nt!==void 0?nt.length:0;let Mt=0;k.morphAttributes.position!==void 0&&(Mt=1),k.morphAttributes.normal!==void 0&&(Mt=2),k.morphAttributes.color!==void 0&&(Mt=3);let Dt,K,Z,ft;if(et){const Wt=vn[et];Dt=Wt.vertexShader,K=Wt.fragmentShader}else Dt=y.vertexShader,K=y.fragmentShader,l.update(y),Z=l.getVertexShaderID(y),ft=l.getFragmentShaderID(y);const ct=r.getRenderTarget(),Nt=I.isInstancedMesh===!0,wt=I.isBatchedMesh===!0,kt=!!y.map,U=!!y.matcap,Ht=!!G,zt=!!y.aoMap,Zt=!!y.lightMap,xt=!!y.bumpMap,Gt=!!y.normalMap,Ot=!!y.displacementMap,Rt=!!y.emissiveMap,te=!!y.metalnessMap,L=!!y.roughnessMap,A=y.anisotropy>0,Y=y.clearcoat>0,$=y.dispersion>0,Q=y.iridescence>0,tt=y.sheen>0,_t=y.transmission>0,at=A&&!!y.anisotropyMap,st=Y&&!!y.clearcoatMap,Ct=Y&&!!y.clearcoatNormalMap,it=Y&&!!y.clearcoatRoughnessMap,pt=Q&&!!y.iridescenceMap,Ft=Q&&!!y.iridescenceThicknessMap,yt=tt&&!!y.sheenColorMap,ut=tt&&!!y.sheenRoughnessMap,Pt=!!y.specularMap,Lt=!!y.specularColorMap,se=!!y.specularIntensityMap,v=_t&&!!y.transmissionMap,q=_t&&!!y.thicknessMap,V=!!y.gradientMap,j=!!y.alphaMap,J=y.alphaTest>0,gt=!!y.alphaHash,At=!!y.extensions;let ae=ni;y.toneMapped&&(ct===null||ct.isXRRenderTarget===!0)&&(ae=r.toneMapping);const he={shaderID:et,shaderType:y.type,shaderName:y.name,vertexShader:Dt,fragmentShader:K,defines:y.defines,customVertexShaderID:Z,customFragmentShaderID:ft,isRawShaderMaterial:y.isRawShaderMaterial===!0,glslVersion:y.glslVersion,precision:d,batching:wt,batchingColor:wt&&I._colorsTexture!==null,instancing:Nt,instancingColor:Nt&&I.instanceColor!==null,instancingMorph:Nt&&I.morphTexture!==null,supportsVertexTextures:f,outputColorSpace:ct===null?r.outputColorSpace:ct.isXRRenderTarget===!0?ct.texture.colorSpace:hi,alphaToCoverage:!!y.alphaToCoverage,map:kt,matcap:U,envMap:Ht,envMapMode:Ht&&G.mapping,envMapCubeUVHeight:z,aoMap:zt,lightMap:Zt,bumpMap:xt,normalMap:Gt,displacementMap:f&&Ot,emissiveMap:Rt,normalMapObjectSpace:Gt&&y.normalMapType===If,normalMapTangentSpace:Gt&&y.normalMapType===Ao,metalnessMap:te,roughnessMap:L,anisotropy:A,anisotropyMap:at,clearcoat:Y,clearcoatMap:st,clearcoatNormalMap:Ct,clearcoatRoughnessMap:it,dispersion:$,iridescence:Q,iridescenceMap:pt,iridescenceThicknessMap:Ft,sheen:tt,sheenColorMap:yt,sheenRoughnessMap:ut,specularMap:Pt,specularColorMap:Lt,specularIntensityMap:se,transmission:_t,transmissionMap:v,thicknessMap:q,gradientMap:V,opaque:y.transparent===!1&&y.blending===lr&&y.alphaToCoverage===!1,alphaMap:j,alphaTest:J,alphaHash:gt,combine:y.combine,mapUv:kt&&_(y.map.channel),aoMapUv:zt&&_(y.aoMap.channel),lightMapUv:Zt&&_(y.lightMap.channel),bumpMapUv:xt&&_(y.bumpMap.channel),normalMapUv:Gt&&_(y.normalMap.channel),displacementMapUv:Ot&&_(y.displacementMap.channel),emissiveMapUv:Rt&&_(y.emissiveMap.channel),metalnessMapUv:te&&_(y.metalnessMap.channel),roughnessMapUv:L&&_(y.roughnessMap.channel),anisotropyMapUv:at&&_(y.anisotropyMap.channel),clearcoatMapUv:st&&_(y.clearcoatMap.channel),clearcoatNormalMapUv:Ct&&_(y.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:it&&_(y.clearcoatRoughnessMap.channel),iridescenceMapUv:pt&&_(y.iridescenceMap.channel),iridescenceThicknessMapUv:Ft&&_(y.iridescenceThicknessMap.channel),sheenColorMapUv:yt&&_(y.sheenColorMap.channel),sheenRoughnessMapUv:ut&&_(y.sheenRoughnessMap.channel),specularMapUv:Pt&&_(y.specularMap.channel),specularColorMapUv:Lt&&_(y.specularColorMap.channel),specularIntensityMapUv:se&&_(y.specularIntensityMap.channel),transmissionMapUv:v&&_(y.transmissionMap.channel),thicknessMapUv:q&&_(y.thicknessMap.channel),alphaMapUv:j&&_(y.alphaMap.channel),vertexTangents:!!k.attributes.tangent&&(Gt||A),vertexColors:y.vertexColors,vertexAlphas:y.vertexColors===!0&&!!k.attributes.color&&k.attributes.color.itemSize===4,pointsUvs:I.isPoints===!0&&!!k.attributes.uv&&(kt||j),fog:!!N,useFog:y.fog===!0,fogExp2:!!N&&N.isFogExp2,flatShading:y.flatShading===!0,sizeAttenuation:y.sizeAttenuation===!0,logarithmicDepthBuffer:h,skinning:I.isSkinnedMesh===!0,morphTargets:k.morphAttributes.position!==void 0,morphNormals:k.morphAttributes.normal!==void 0,morphColors:k.morphAttributes.color!==void 0,morphTargetsCount:lt,morphTextureStride:Mt,numDirLights:M.directional.length,numPointLights:M.point.length,numSpotLights:M.spot.length,numSpotLightMaps:M.spotLightMap.length,numRectAreaLights:M.rectArea.length,numHemiLights:M.hemi.length,numDirLightShadows:M.directionalShadowMap.length,numPointLightShadows:M.pointShadowMap.length,numSpotLightShadows:M.spotShadowMap.length,numSpotLightShadowsWithMaps:M.numSpotLightShadowsWithMaps,numLightProbes:M.numLightProbes,numClippingPlanes:a.numPlanes,numClipIntersection:a.numIntersection,dithering:y.dithering,shadowMapEnabled:r.shadowMap.enabled&&C.length>0,shadowMapType:r.shadowMap.type,toneMapping:ae,decodeVideoTexture:kt&&y.map.isVideoTexture===!0&&qt.getTransfer(y.map.colorSpace)===Jt,premultipliedAlpha:y.premultipliedAlpha,doubleSided:y.side===On,flipSided:y.side===Be,useDepthPacking:y.depthPacking>=0,depthPacking:y.depthPacking||0,index0AttributeName:y.index0AttributeName,extensionClipCullDistance:At&&y.extensions.clipCullDistance===!0&&n.has("WEBGL_clip_cull_distance"),extensionMultiDraw:At&&y.extensions.multiDraw===!0&&n.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:y.customProgramCacheKey()};return he.vertexUv1s=c.has(1),he.vertexUv2s=c.has(2),he.vertexUv3s=c.has(3),c.clear(),he}function m(y){const M=[];if(y.shaderID?M.push(y.shaderID):(M.push(y.customVertexShaderID),M.push(y.customFragmentShaderID)),y.defines!==void 0)for(const C in y.defines)M.push(C),M.push(y.defines[C]);return y.isRawShaderMaterial===!1&&(S(M,y),x(M,y),M.push(r.outputColorSpace)),M.push(y.customProgramCacheKey),M.join()}function S(y,M){y.push(M.precision),y.push(M.outputColorSpace),y.push(M.envMapMode),y.push(M.envMapCubeUVHeight),y.push(M.mapUv),y.push(M.alphaMapUv),y.push(M.lightMapUv),y.push(M.aoMapUv),y.push(M.bumpMapUv),y.push(M.normalMapUv),y.push(M.displacementMapUv),y.push(M.emissiveMapUv),y.push(M.metalnessMapUv),y.push(M.roughnessMapUv),y.push(M.anisotropyMapUv),y.push(M.clearcoatMapUv),y.push(M.clearcoatNormalMapUv),y.push(M.clearcoatRoughnessMapUv),y.push(M.iridescenceMapUv),y.push(M.iridescenceThicknessMapUv),y.push(M.sheenColorMapUv),y.push(M.sheenRoughnessMapUv),y.push(M.specularMapUv),y.push(M.specularColorMapUv),y.push(M.specularIntensityMapUv),y.push(M.transmissionMapUv),y.push(M.thicknessMapUv),y.push(M.combine),y.push(M.fogExp2),y.push(M.sizeAttenuation),y.push(M.morphTargetsCount),y.push(M.morphAttributeCount),y.push(M.numDirLights),y.push(M.numPointLights),y.push(M.numSpotLights),y.push(M.numSpotLightMaps),y.push(M.numHemiLights),y.push(M.numRectAreaLights),y.push(M.numDirLightShadows),y.push(M.numPointLightShadows),y.push(M.numSpotLightShadows),y.push(M.numSpotLightShadowsWithMaps),y.push(M.numLightProbes),y.push(M.shadowMapType),y.push(M.toneMapping),y.push(M.numClippingPlanes),y.push(M.numClipIntersection),y.push(M.depthPacking)}function x(y,M){o.disableAll(),M.supportsVertexTextures&&o.enable(0),M.instancing&&o.enable(1),M.instancingColor&&o.enable(2),M.instancingMorph&&o.enable(3),M.matcap&&o.enable(4),M.envMap&&o.enable(5),M.normalMapObjectSpace&&o.enable(6),M.normalMapTangentSpace&&o.enable(7),M.clearcoat&&o.enable(8),M.iridescence&&o.enable(9),M.alphaTest&&o.enable(10),M.vertexColors&&o.enable(11),M.vertexAlphas&&o.enable(12),M.vertexUv1s&&o.enable(13),M.vertexUv2s&&o.enable(14),M.vertexUv3s&&o.enable(15),M.vertexTangents&&o.enable(16),M.anisotropy&&o.enable(17),M.alphaHash&&o.enable(18),M.batching&&o.enable(19),M.dispersion&&o.enable(20),M.batchingColor&&o.enable(21),y.push(o.mask),o.disableAll(),M.fog&&o.enable(0),M.useFog&&o.enable(1),M.flatShading&&o.enable(2),M.logarithmicDepthBuffer&&o.enable(3),M.skinning&&o.enable(4),M.morphTargets&&o.enable(5),M.morphNormals&&o.enable(6),M.morphColors&&o.enable(7),M.premultipliedAlpha&&o.enable(8),M.shadowMapEnabled&&o.enable(9),M.doubleSided&&o.enable(10),M.flipSided&&o.enable(11),M.useDepthPacking&&o.enable(12),M.dithering&&o.enable(13),M.transmission&&o.enable(14),M.sheen&&o.enable(15),M.opaque&&o.enable(16),M.pointsUvs&&o.enable(17),M.decodeVideoTexture&&o.enable(18),M.alphaToCoverage&&o.enable(19),y.push(o.mask)}function E(y){const M=g[y.type];let C;if(M){const D=vn[M];C=ld.clone(D.uniforms)}else C=y.uniforms;return C}function w(y,M){let C;for(let D=0,I=u.length;D<I;D++){const N=u[D];if(N.cacheKey===M){C=N,++C.usedTimes;break}}return C===void 0&&(C=new Mg(r,M,y,s),u.push(C)),C}function b(y){if(--y.usedTimes===0){const M=u.indexOf(y);u[M]=u[u.length-1],u.pop(),y.destroy()}}function T(y){l.remove(y)}function P(){l.dispose()}return{getParameters:p,getProgramCacheKey:m,getUniforms:E,acquireProgram:w,releaseProgram:b,releaseShaderCache:T,programs:u,dispose:P}}function bg(){let r=new WeakMap;function t(s){let a=r.get(s);return a===void 0&&(a={},r.set(s,a)),a}function e(s){r.delete(s)}function n(s,a,o){r.get(s)[a]=o}function i(){r=new WeakMap}return{get:t,remove:e,update:n,dispose:i}}function Ag(r,t){return r.groupOrder!==t.groupOrder?r.groupOrder-t.groupOrder:r.renderOrder!==t.renderOrder?r.renderOrder-t.renderOrder:r.material.id!==t.material.id?r.material.id-t.material.id:r.z!==t.z?r.z-t.z:r.id-t.id}function xc(r,t){return r.groupOrder!==t.groupOrder?r.groupOrder-t.groupOrder:r.renderOrder!==t.renderOrder?r.renderOrder-t.renderOrder:r.z!==t.z?t.z-r.z:r.id-t.id}function Mc(){const r=[];let t=0;const e=[],n=[],i=[];function s(){t=0,e.length=0,n.length=0,i.length=0}function a(h,f,d,g,_,p){let m=r[t];return m===void 0?(m={id:h.id,object:h,geometry:f,material:d,groupOrder:g,renderOrder:h.renderOrder,z:_,group:p},r[t]=m):(m.id=h.id,m.object=h,m.geometry=f,m.material=d,m.groupOrder=g,m.renderOrder=h.renderOrder,m.z=_,m.group=p),t++,m}function o(h,f,d,g,_,p){const m=a(h,f,d,g,_,p);d.transmission>0?n.push(m):d.transparent===!0?i.push(m):e.push(m)}function l(h,f,d,g,_,p){const m=a(h,f,d,g,_,p);d.transmission>0?n.unshift(m):d.transparent===!0?i.unshift(m):e.unshift(m)}function c(h,f){e.length>1&&e.sort(h||Ag),n.length>1&&n.sort(f||xc),i.length>1&&i.sort(f||xc)}function u(){for(let h=t,f=r.length;h<f;h++){const d=r[h];if(d.id===null)break;d.id=null,d.object=null,d.geometry=null,d.material=null,d.group=null}}return{opaque:e,transmissive:n,transparent:i,init:s,push:o,unshift:l,finish:u,sort:c}}function wg(){let r=new WeakMap;function t(n,i){const s=r.get(n);let a;return s===void 0?(a=new Mc,r.set(n,[a])):i>=s.length?(a=new Mc,s.push(a)):a=s[i],a}function e(){r=new WeakMap}return{get:t,dispose:e}}function Rg(){const r={};return{get:function(t){if(r[t.id]!==void 0)return r[t.id];let e;switch(t.type){case"DirectionalLight":e={direction:new F,color:new Bt};break;case"SpotLight":e={position:new F,direction:new F,color:new Bt,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":e={position:new F,color:new Bt,distance:0,decay:0};break;case"HemisphereLight":e={direction:new F,skyColor:new Bt,groundColor:new Bt};break;case"RectAreaLight":e={color:new Bt,position:new F,halfWidth:new F,halfHeight:new F};break}return r[t.id]=e,e}}}function Cg(){const r={};return{get:function(t){if(r[t.id]!==void 0)return r[t.id];let e;switch(t.type){case"DirectionalLight":e={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new bt};break;case"SpotLight":e={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new bt};break;case"PointLight":e={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new bt,shadowCameraNear:1,shadowCameraFar:1e3};break}return r[t.id]=e,e}}}let Pg=0;function Lg(r,t){return(t.castShadow?2:0)-(r.castShadow?2:0)+(t.map?1:0)-(r.map?1:0)}function Dg(r){const t=new Rg,e=Cg(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)n.probe.push(new F);const i=new F,s=new re,a=new re;function o(c){let u=0,h=0,f=0;for(let y=0;y<9;y++)n.probe[y].set(0,0,0);let d=0,g=0,_=0,p=0,m=0,S=0,x=0,E=0,w=0,b=0,T=0;c.sort(Lg);for(let y=0,M=c.length;y<M;y++){const C=c[y],D=C.color,I=C.intensity,N=C.distance,k=C.shadow&&C.shadow.map?C.shadow.map.texture:null;if(C.isAmbientLight)u+=D.r*I,h+=D.g*I,f+=D.b*I;else if(C.isLightProbe){for(let O=0;O<9;O++)n.probe[O].addScaledVector(C.sh.coefficients[O],I);T++}else if(C.isDirectionalLight){const O=t.get(C);if(O.color.copy(C.color).multiplyScalar(C.intensity),C.castShadow){const G=C.shadow,z=e.get(C);z.shadowBias=G.bias,z.shadowNormalBias=G.normalBias,z.shadowRadius=G.radius,z.shadowMapSize=G.mapSize,n.directionalShadow[d]=z,n.directionalShadowMap[d]=k,n.directionalShadowMatrix[d]=C.shadow.matrix,S++}n.directional[d]=O,d++}else if(C.isSpotLight){const O=t.get(C);O.position.setFromMatrixPosition(C.matrixWorld),O.color.copy(D).multiplyScalar(I),O.distance=N,O.coneCos=Math.cos(C.angle),O.penumbraCos=Math.cos(C.angle*(1-C.penumbra)),O.decay=C.decay,n.spot[_]=O;const G=C.shadow;if(C.map&&(n.spotLightMap[w]=C.map,w++,G.updateMatrices(C),C.castShadow&&b++),n.spotLightMatrix[_]=G.matrix,C.castShadow){const z=e.get(C);z.shadowBias=G.bias,z.shadowNormalBias=G.normalBias,z.shadowRadius=G.radius,z.shadowMapSize=G.mapSize,n.spotShadow[_]=z,n.spotShadowMap[_]=k,E++}_++}else if(C.isRectAreaLight){const O=t.get(C);O.color.copy(D).multiplyScalar(I),O.halfWidth.set(C.width*.5,0,0),O.halfHeight.set(0,C.height*.5,0),n.rectArea[p]=O,p++}else if(C.isPointLight){const O=t.get(C);if(O.color.copy(C.color).multiplyScalar(C.intensity),O.distance=C.distance,O.decay=C.decay,C.castShadow){const G=C.shadow,z=e.get(C);z.shadowBias=G.bias,z.shadowNormalBias=G.normalBias,z.shadowRadius=G.radius,z.shadowMapSize=G.mapSize,z.shadowCameraNear=G.camera.near,z.shadowCameraFar=G.camera.far,n.pointShadow[g]=z,n.pointShadowMap[g]=k,n.pointShadowMatrix[g]=C.shadow.matrix,x++}n.point[g]=O,g++}else if(C.isHemisphereLight){const O=t.get(C);O.skyColor.copy(C.color).multiplyScalar(I),O.groundColor.copy(C.groundColor).multiplyScalar(I),n.hemi[m]=O,m++}}p>0&&(r.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=ot.LTC_FLOAT_1,n.rectAreaLTC2=ot.LTC_FLOAT_2):(n.rectAreaLTC1=ot.LTC_HALF_1,n.rectAreaLTC2=ot.LTC_HALF_2)),n.ambient[0]=u,n.ambient[1]=h,n.ambient[2]=f;const P=n.hash;(P.directionalLength!==d||P.pointLength!==g||P.spotLength!==_||P.rectAreaLength!==p||P.hemiLength!==m||P.numDirectionalShadows!==S||P.numPointShadows!==x||P.numSpotShadows!==E||P.numSpotMaps!==w||P.numLightProbes!==T)&&(n.directional.length=d,n.spot.length=_,n.rectArea.length=p,n.point.length=g,n.hemi.length=m,n.directionalShadow.length=S,n.directionalShadowMap.length=S,n.pointShadow.length=x,n.pointShadowMap.length=x,n.spotShadow.length=E,n.spotShadowMap.length=E,n.directionalShadowMatrix.length=S,n.pointShadowMatrix.length=x,n.spotLightMatrix.length=E+w-b,n.spotLightMap.length=w,n.numSpotLightShadowsWithMaps=b,n.numLightProbes=T,P.directionalLength=d,P.pointLength=g,P.spotLength=_,P.rectAreaLength=p,P.hemiLength=m,P.numDirectionalShadows=S,P.numPointShadows=x,P.numSpotShadows=E,P.numSpotMaps=w,P.numLightProbes=T,n.version=Pg++)}function l(c,u){let h=0,f=0,d=0,g=0,_=0;const p=u.matrixWorldInverse;for(let m=0,S=c.length;m<S;m++){const x=c[m];if(x.isDirectionalLight){const E=n.directional[h];E.direction.setFromMatrixPosition(x.matrixWorld),i.setFromMatrixPosition(x.target.matrixWorld),E.direction.sub(i),E.direction.transformDirection(p),h++}else if(x.isSpotLight){const E=n.spot[d];E.position.setFromMatrixPosition(x.matrixWorld),E.position.applyMatrix4(p),E.direction.setFromMatrixPosition(x.matrixWorld),i.setFromMatrixPosition(x.target.matrixWorld),E.direction.sub(i),E.direction.transformDirection(p),d++}else if(x.isRectAreaLight){const E=n.rectArea[g];E.position.setFromMatrixPosition(x.matrixWorld),E.position.applyMatrix4(p),a.identity(),s.copy(x.matrixWorld),s.premultiply(p),a.extractRotation(s),E.halfWidth.set(x.width*.5,0,0),E.halfHeight.set(0,x.height*.5,0),E.halfWidth.applyMatrix4(a),E.halfHeight.applyMatrix4(a),g++}else if(x.isPointLight){const E=n.point[f];E.position.setFromMatrixPosition(x.matrixWorld),E.position.applyMatrix4(p),f++}else if(x.isHemisphereLight){const E=n.hemi[_];E.direction.setFromMatrixPosition(x.matrixWorld),E.direction.transformDirection(p),_++}}}return{setup:o,setupView:l,state:n}}function Sc(r){const t=new Dg(r),e=[],n=[];function i(u){c.camera=u,e.length=0,n.length=0}function s(u){e.push(u)}function a(u){n.push(u)}function o(){t.setup(e)}function l(u){t.setupView(e,u)}const c={lightsArray:e,shadowsArray:n,camera:null,lights:t,transmissionRenderTarget:{}};return{init:i,state:c,setupLights:o,setupLightsView:l,pushLight:s,pushShadow:a}}function Ig(r){let t=new WeakMap;function e(i,s=0){const a=t.get(i);let o;return a===void 0?(o=new Sc(r),t.set(i,[o])):s>=a.length?(o=new Sc(r),a.push(o)):o=a[s],o}function n(){t=new WeakMap}return{get:e,dispose:n}}class Ug extends Fi{constructor(t){super(),this.isMeshDepthMaterial=!0,this.type="MeshDepthMaterial",this.depthPacking=Lf,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.wireframe=!1,this.wireframeLinewidth=1,this.setValues(t)}copy(t){return super.copy(t),this.depthPacking=t.depthPacking,this.map=t.map,this.alphaMap=t.alphaMap,this.displacementMap=t.displacementMap,this.displacementScale=t.displacementScale,this.displacementBias=t.displacementBias,this.wireframe=t.wireframe,this.wireframeLinewidth=t.wireframeLinewidth,this}}class Ng extends Fi{constructor(t){super(),this.isMeshDistanceMaterial=!0,this.type="MeshDistanceMaterial",this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.setValues(t)}copy(t){return super.copy(t),this.map=t.map,this.alphaMap=t.alphaMap,this.displacementMap=t.displacementMap,this.displacementScale=t.displacementScale,this.displacementBias=t.displacementBias,this}}const Og=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function Bg(r,t,e){let n=new Po;const i=new bt,s=new bt,a=new Se,o=new Ug({depthPacking:Df}),l=new Ng,c={},u=e.maxTextureSize,h={[si]:Be,[Be]:si,[On]:On},f=new oi({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new bt},radius:{value:4}},vertexShader:Og,fragmentShader:Fg}),d=f.clone();d.defines.HORIZONTAL_PASS=1;const g=new hn;g.setAttribute("position",new Tn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new Fe(g,f),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=iu;let m=this.type;this.render=function(b,T,P){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||b.length===0)return;const y=r.getRenderTarget(),M=r.getActiveCubeFace(),C=r.getActiveMipmapLevel(),D=r.state;D.setBlending(ei),D.buffers.color.setClear(1,1,1,1),D.buffers.depth.setTest(!0),D.setScissorTest(!1);const I=m!==In&&this.type===In,N=m===In&&this.type!==In;for(let k=0,O=b.length;k<O;k++){const G=b[k],z=G.shadow;if(z===void 0){console.warn("THREE.WebGLShadowMap:",G,"has no shadow.");continue}if(z.autoUpdate===!1&&z.needsUpdate===!1)continue;i.copy(z.mapSize);const et=z.getFrameExtents();if(i.multiply(et),s.copy(z.mapSize),(i.x>u||i.y>u)&&(i.x>u&&(s.x=Math.floor(u/et.x),i.x=s.x*et.x,z.mapSize.x=s.x),i.y>u&&(s.y=Math.floor(u/et.y),i.y=s.y*et.y,z.mapSize.y=s.y)),z.map===null||I===!0||N===!0){const lt=this.type!==In?{minFilter:ln,magFilter:ln}:{};z.map!==null&&z.map.dispose(),z.map=new Ui(i.x,i.y,lt),z.map.texture.name=G.name+".shadowMap",z.camera.updateProjectionMatrix()}r.setRenderTarget(z.map),r.clear();const nt=z.getViewportCount();for(let lt=0;lt<nt;lt++){const Mt=z.getViewport(lt);a.set(s.x*Mt.x,s.y*Mt.y,s.x*Mt.z,s.y*Mt.w),D.viewport(a),z.updateMatrices(G,lt),n=z.getFrustum(),E(T,P,z.camera,G,this.type)}z.isPointLightShadow!==!0&&this.type===In&&S(z,P),z.needsUpdate=!1}m=this.type,p.needsUpdate=!1,r.setRenderTarget(y,M,C)};function S(b,T){const P=t.update(_);f.defines.VSM_SAMPLES!==b.blurSamples&&(f.defines.VSM_SAMPLES=b.blurSamples,d.defines.VSM_SAMPLES=b.blurSamples,f.needsUpdate=!0,d.needsUpdate=!0),b.mapPass===null&&(b.mapPass=new Ui(i.x,i.y)),f.uniforms.shadow_pass.value=b.map.texture,f.uniforms.resolution.value=b.mapSize,f.uniforms.radius.value=b.radius,r.setRenderTarget(b.mapPass),r.clear(),r.renderBufferDirect(T,null,P,f,_,null),d.uniforms.shadow_pass.value=b.mapPass.texture,d.uniforms.resolution.value=b.mapSize,d.uniforms.radius.value=b.radius,r.setRenderTarget(b.map),r.clear(),r.renderBufferDirect(T,null,P,d,_,null)}function x(b,T,P,y){let M=null;const C=P.isPointLight===!0?b.customDistanceMaterial:b.customDepthMaterial;if(C!==void 0)M=C;else if(M=P.isPointLight===!0?l:o,r.localClippingEnabled&&T.clipShadows===!0&&Array.isArray(T.clippingPlanes)&&T.clippingPlanes.length!==0||T.displacementMap&&T.displacementScale!==0||T.alphaMap&&T.alphaTest>0||T.map&&T.alphaTest>0){const D=M.uuid,I=T.uuid;let N=c[D];N===void 0&&(N={},c[D]=N);let k=N[I];k===void 0&&(k=M.clone(),N[I]=k,T.addEventListener("dispose",w)),M=k}if(M.visible=T.visible,M.wireframe=T.wireframe,y===In?M.side=T.shadowSide!==null?T.shadowSide:T.side:M.side=T.shadowSide!==null?T.shadowSide:h[T.side],M.alphaMap=T.alphaMap,M.alphaTest=T.alphaTest,M.map=T.map,M.clipShadows=T.clipShadows,M.clippingPlanes=T.clippingPlanes,M.clipIntersection=T.clipIntersection,M.displacementMap=T.displacementMap,M.displacementScale=T.displacementScale,M.displacementBias=T.displacementBias,M.wireframeLinewidth=T.wireframeLinewidth,M.linewidth=T.linewidth,P.isPointLight===!0&&M.isMeshDistanceMaterial===!0){const D=r.properties.get(M);D.light=P}return M}function E(b,T,P,y,M){if(b.visible===!1)return;if(b.layers.test(T.layers)&&(b.isMesh||b.isLine||b.isPoints)&&(b.castShadow||b.receiveShadow&&M===In)&&(!b.frustumCulled||n.intersectsObject(b))){b.modelViewMatrix.multiplyMatrices(P.matrixWorldInverse,b.matrixWorld);const I=t.update(b),N=b.material;if(Array.isArray(N)){const k=I.groups;for(let O=0,G=k.length;O<G;O++){const z=k[O],et=N[z.materialIndex];if(et&&et.visible){const nt=x(b,et,y,M);b.onBeforeShadow(r,b,T,P,I,nt,z),r.renderBufferDirect(P,null,I,nt,b,z),b.onAfterShadow(r,b,T,P,I,nt,z)}}}else if(N.visible){const k=x(b,N,y,M);b.onBeforeShadow(r,b,T,P,I,k,null),r.renderBufferDirect(P,null,I,k,b,null),b.onAfterShadow(r,b,T,P,I,k,null)}}const D=b.children;for(let I=0,N=D.length;I<N;I++)E(D[I],T,P,y,M)}function w(b){b.target.removeEventListener("dispose",w);for(const P in c){const y=c[P],M=b.target.uuid;M in y&&(y[M].dispose(),delete y[M])}}}function zg(r){function t(){let v=!1;const q=new Se;let V=null;const j=new Se(0,0,0,0);return{setMask:function(J){V!==J&&!v&&(r.colorMask(J,J,J,J),V=J)},setLocked:function(J){v=J},setClear:function(J,gt,At,ae,he){he===!0&&(J*=ae,gt*=ae,At*=ae),q.set(J,gt,At,ae),j.equals(q)===!1&&(r.clearColor(J,gt,At,ae),j.copy(q))},reset:function(){v=!1,V=null,j.set(-1,0,0,0)}}}function e(){let v=!1,q=null,V=null,j=null;return{setTest:function(J){J?ft(r.DEPTH_TEST):ct(r.DEPTH_TEST)},setMask:function(J){q!==J&&!v&&(r.depthMask(J),q=J)},setFunc:function(J){if(V!==J){switch(J){case rf:r.depthFunc(r.NEVER);break;case sf:r.depthFunc(r.ALWAYS);break;case af:r.depthFunc(r.LESS);break;case Is:r.depthFunc(r.LEQUAL);break;case of:r.depthFunc(r.EQUAL);break;case lf:r.depthFunc(r.GEQUAL);break;case cf:r.depthFunc(r.GREATER);break;case uf:r.depthFunc(r.NOTEQUAL);break;default:r.depthFunc(r.LEQUAL)}V=J}},setLocked:function(J){v=J},setClear:function(J){j!==J&&(r.clearDepth(J),j=J)},reset:function(){v=!1,q=null,V=null,j=null}}}function n(){let v=!1,q=null,V=null,j=null,J=null,gt=null,At=null,ae=null,he=null;return{setTest:function(Wt){v||(Wt?ft(r.STENCIL_TEST):ct(r.STENCIL_TEST))},setMask:function(Wt){q!==Wt&&!v&&(r.stencilMask(Wt),q=Wt)},setFunc:function(Wt,fe,de){(V!==Wt||j!==fe||J!==de)&&(r.stencilFunc(Wt,fe,de),V=Wt,j=fe,J=de)},setOp:function(Wt,fe,de){(gt!==Wt||At!==fe||ae!==de)&&(r.stencilOp(Wt,fe,de),gt=Wt,At=fe,ae=de)},setLocked:function(Wt){v=Wt},setClear:function(Wt){he!==Wt&&(r.clearStencil(Wt),he=Wt)},reset:function(){v=!1,q=null,V=null,j=null,J=null,gt=null,At=null,ae=null,he=null}}}const i=new t,s=new e,a=new n,o=new WeakMap,l=new WeakMap;let c={},u={},h=new WeakMap,f=[],d=null,g=!1,_=null,p=null,m=null,S=null,x=null,E=null,w=null,b=new Bt(0,0,0),T=0,P=!1,y=null,M=null,C=null,D=null,I=null;const N=r.getParameter(r.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let k=!1,O=0;const G=r.getParameter(r.VERSION);G.indexOf("WebGL")!==-1?(O=parseFloat(/^WebGL (\d)/.exec(G)[1]),k=O>=1):G.indexOf("OpenGL ES")!==-1&&(O=parseFloat(/^OpenGL ES (\d)/.exec(G)[1]),k=O>=2);let z=null,et={};const nt=r.getParameter(r.SCISSOR_BOX),lt=r.getParameter(r.VIEWPORT),Mt=new Se().fromArray(nt),Dt=new Se().fromArray(lt);function K(v,q,V,j){const J=new Uint8Array(4),gt=r.createTexture();r.bindTexture(v,gt),r.texParameteri(v,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(v,r.TEXTURE_MAG_FILTER,r.NEAREST);for(let At=0;At<V;At++)v===r.TEXTURE_3D||v===r.TEXTURE_2D_ARRAY?r.texImage3D(q,0,r.RGBA,1,1,j,0,r.RGBA,r.UNSIGNED_BYTE,J):r.texImage2D(q+At,0,r.RGBA,1,1,0,r.RGBA,r.UNSIGNED_BYTE,J);return gt}const Z={};Z[r.TEXTURE_2D]=K(r.TEXTURE_2D,r.TEXTURE_2D,1),Z[r.TEXTURE_CUBE_MAP]=K(r.TEXTURE_CUBE_MAP,r.TEXTURE_CUBE_MAP_POSITIVE_X,6),Z[r.TEXTURE_2D_ARRAY]=K(r.TEXTURE_2D_ARRAY,r.TEXTURE_2D_ARRAY,1,1),Z[r.TEXTURE_3D]=K(r.TEXTURE_3D,r.TEXTURE_3D,1,1),i.setClear(0,0,0,1),s.setClear(1),a.setClear(0),ft(r.DEPTH_TEST),s.setFunc(Is),xt(!1),Gt(il),ft(r.CULL_FACE),zt(ei);function ft(v){c[v]!==!0&&(r.enable(v),c[v]=!0)}function ct(v){c[v]!==!1&&(r.disable(v),c[v]=!1)}function Nt(v,q){return u[v]!==q?(r.bindFramebuffer(v,q),u[v]=q,v===r.DRAW_FRAMEBUFFER&&(u[r.FRAMEBUFFER]=q),v===r.FRAMEBUFFER&&(u[r.DRAW_FRAMEBUFFER]=q),!0):!1}function wt(v,q){let V=f,j=!1;if(v){V=h.get(q),V===void 0&&(V=[],h.set(q,V));const J=v.textures;if(V.length!==J.length||V[0]!==r.COLOR_ATTACHMENT0){for(let gt=0,At=J.length;gt<At;gt++)V[gt]=r.COLOR_ATTACHMENT0+gt;V.length=J.length,j=!0}}else V[0]!==r.BACK&&(V[0]=r.BACK,j=!0);j&&r.drawBuffers(V)}function kt(v){return d!==v?(r.useProgram(v),d=v,!0):!1}const U={[Ai]:r.FUNC_ADD,[kh]:r.FUNC_SUBTRACT,[Hh]:r.FUNC_REVERSE_SUBTRACT};U[Gh]=r.MIN,U[Vh]=r.MAX;const Ht={[Wh]:r.ZERO,[Xh]:r.ONE,[Yh]:r.SRC_COLOR,[to]:r.SRC_ALPHA,[Jh]:r.SRC_ALPHA_SATURATE,[$h]:r.DST_COLOR,[jh]:r.DST_ALPHA,[qh]:r.ONE_MINUS_SRC_COLOR,[eo]:r.ONE_MINUS_SRC_ALPHA,[Zh]:r.ONE_MINUS_DST_COLOR,[Kh]:r.ONE_MINUS_DST_ALPHA,[Qh]:r.CONSTANT_COLOR,[tf]:r.ONE_MINUS_CONSTANT_COLOR,[ef]:r.CONSTANT_ALPHA,[nf]:r.ONE_MINUS_CONSTANT_ALPHA};function zt(v,q,V,j,J,gt,At,ae,he,Wt){if(v===ei){g===!0&&(ct(r.BLEND),g=!1);return}if(g===!1&&(ft(r.BLEND),g=!0),v!==zh){if(v!==_||Wt!==P){if((p!==Ai||x!==Ai)&&(r.blendEquation(r.FUNC_ADD),p=Ai,x=Ai),Wt)switch(v){case lr:r.blendFuncSeparate(r.ONE,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case Qa:r.blendFunc(r.ONE,r.ONE);break;case rl:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case sl:r.blendFuncSeparate(r.ZERO,r.SRC_COLOR,r.ZERO,r.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",v);break}else switch(v){case lr:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case Qa:r.blendFunc(r.SRC_ALPHA,r.ONE);break;case rl:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case sl:r.blendFunc(r.ZERO,r.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",v);break}m=null,S=null,E=null,w=null,b.set(0,0,0),T=0,_=v,P=Wt}return}J=J||q,gt=gt||V,At=At||j,(q!==p||J!==x)&&(r.blendEquationSeparate(U[q],U[J]),p=q,x=J),(V!==m||j!==S||gt!==E||At!==w)&&(r.blendFuncSeparate(Ht[V],Ht[j],Ht[gt],Ht[At]),m=V,S=j,E=gt,w=At),(ae.equals(b)===!1||he!==T)&&(r.blendColor(ae.r,ae.g,ae.b,he),b.copy(ae),T=he),_=v,P=!1}function Zt(v,q){v.side===On?ct(r.CULL_FACE):ft(r.CULL_FACE);let V=v.side===Be;q&&(V=!V),xt(V),v.blending===lr&&v.transparent===!1?zt(ei):zt(v.blending,v.blendEquation,v.blendSrc,v.blendDst,v.blendEquationAlpha,v.blendSrcAlpha,v.blendDstAlpha,v.blendColor,v.blendAlpha,v.premultipliedAlpha),s.setFunc(v.depthFunc),s.setTest(v.depthTest),s.setMask(v.depthWrite),i.setMask(v.colorWrite);const j=v.stencilWrite;a.setTest(j),j&&(a.setMask(v.stencilWriteMask),a.setFunc(v.stencilFunc,v.stencilRef,v.stencilFuncMask),a.setOp(v.stencilFail,v.stencilZFail,v.stencilZPass)),Rt(v.polygonOffset,v.polygonOffsetFactor,v.polygonOffsetUnits),v.alphaToCoverage===!0?ft(r.SAMPLE_ALPHA_TO_COVERAGE):ct(r.SAMPLE_ALPHA_TO_COVERAGE)}function xt(v){y!==v&&(v?r.frontFace(r.CW):r.frontFace(r.CCW),y=v)}function Gt(v){v!==Oh?(ft(r.CULL_FACE),v!==M&&(v===il?r.cullFace(r.BACK):v===Fh?r.cullFace(r.FRONT):r.cullFace(r.FRONT_AND_BACK))):ct(r.CULL_FACE),M=v}function Ot(v){v!==C&&(k&&r.lineWidth(v),C=v)}function Rt(v,q,V){v?(ft(r.POLYGON_OFFSET_FILL),(D!==q||I!==V)&&(r.polygonOffset(q,V),D=q,I=V)):ct(r.POLYGON_OFFSET_FILL)}function te(v){v?ft(r.SCISSOR_TEST):ct(r.SCISSOR_TEST)}function L(v){v===void 0&&(v=r.TEXTURE0+N-1),z!==v&&(r.activeTexture(v),z=v)}function A(v,q,V){V===void 0&&(z===null?V=r.TEXTURE0+N-1:V=z);let j=et[V];j===void 0&&(j={type:void 0,texture:void 0},et[V]=j),(j.type!==v||j.texture!==q)&&(z!==V&&(r.activeTexture(V),z=V),r.bindTexture(v,q||Z[v]),j.type=v,j.texture=q)}function Y(){const v=et[z];v!==void 0&&v.type!==void 0&&(r.bindTexture(v.type,null),v.type=void 0,v.texture=void 0)}function $(){try{r.compressedTexImage2D.apply(r,arguments)}catch(v){console.error("THREE.WebGLState:",v)}}function Q(){try{r.compressedTexImage3D.apply(r,arguments)}catch(v){console.error("THREE.WebGLState:",v)}}function tt(){try{r.texSubImage2D.apply(r,arguments)}catch(v){console.error("THREE.WebGLState:",v)}}function _t(){try{r.texSubImage3D.apply(r,arguments)}catch(v){console.error("THREE.WebGLState:",v)}}function at(){try{r.compressedTexSubImage2D.apply(r,arguments)}catch(v){console.error("THREE.WebGLState:",v)}}function st(){try{r.compressedTexSubImage3D.apply(r,arguments)}catch(v){console.error("THREE.WebGLState:",v)}}function Ct(){try{r.texStorage2D.apply(r,arguments)}catch(v){console.error("THREE.WebGLState:",v)}}function it(){try{r.texStorage3D.apply(r,arguments)}catch(v){console.error("THREE.WebGLState:",v)}}function pt(){try{r.texImage2D.apply(r,arguments)}catch(v){console.error("THREE.WebGLState:",v)}}function Ft(){try{r.texImage3D.apply(r,arguments)}catch(v){console.error("THREE.WebGLState:",v)}}function yt(v){Mt.equals(v)===!1&&(r.scissor(v.x,v.y,v.z,v.w),Mt.copy(v))}function ut(v){Dt.equals(v)===!1&&(r.viewport(v.x,v.y,v.z,v.w),Dt.copy(v))}function Pt(v,q){let V=l.get(q);V===void 0&&(V=new WeakMap,l.set(q,V));let j=V.get(v);j===void 0&&(j=r.getUniformBlockIndex(q,v.name),V.set(v,j))}function Lt(v,q){const j=l.get(q).get(v);o.get(q)!==j&&(r.uniformBlockBinding(q,j,v.__bindingPointIndex),o.set(q,j))}function se(){r.disable(r.BLEND),r.disable(r.CULL_FACE),r.disable(r.DEPTH_TEST),r.disable(r.POLYGON_OFFSET_FILL),r.disable(r.SCISSOR_TEST),r.disable(r.STENCIL_TEST),r.disable(r.SAMPLE_ALPHA_TO_COVERAGE),r.blendEquation(r.FUNC_ADD),r.blendFunc(r.ONE,r.ZERO),r.blendFuncSeparate(r.ONE,r.ZERO,r.ONE,r.ZERO),r.blendColor(0,0,0,0),r.colorMask(!0,!0,!0,!0),r.clearColor(0,0,0,0),r.depthMask(!0),r.depthFunc(r.LESS),r.clearDepth(1),r.stencilMask(4294967295),r.stencilFunc(r.ALWAYS,0,4294967295),r.stencilOp(r.KEEP,r.KEEP,r.KEEP),r.clearStencil(0),r.cullFace(r.BACK),r.frontFace(r.CCW),r.polygonOffset(0,0),r.activeTexture(r.TEXTURE0),r.bindFramebuffer(r.FRAMEBUFFER,null),r.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),r.bindFramebuffer(r.READ_FRAMEBUFFER,null),r.useProgram(null),r.lineWidth(1),r.scissor(0,0,r.canvas.width,r.canvas.height),r.viewport(0,0,r.canvas.width,r.canvas.height),c={},z=null,et={},u={},h=new WeakMap,f=[],d=null,g=!1,_=null,p=null,m=null,S=null,x=null,E=null,w=null,b=new Bt(0,0,0),T=0,P=!1,y=null,M=null,C=null,D=null,I=null,Mt.set(0,0,r.canvas.width,r.canvas.height),Dt.set(0,0,r.canvas.width,r.canvas.height),i.reset(),s.reset(),a.reset()}return{buffers:{color:i,depth:s,stencil:a},enable:ft,disable:ct,bindFramebuffer:Nt,drawBuffers:wt,useProgram:kt,setBlending:zt,setMaterial:Zt,setFlipSided:xt,setCullFace:Gt,setLineWidth:Ot,setPolygonOffset:Rt,setScissorTest:te,activeTexture:L,bindTexture:A,unbindTexture:Y,compressedTexImage2D:$,compressedTexImage3D:Q,texImage2D:pt,texImage3D:Ft,updateUBOMapping:Pt,uniformBlockBinding:Lt,texStorage2D:Ct,texStorage3D:it,texSubImage2D:tt,texSubImage3D:_t,compressedTexSubImage2D:at,compressedTexSubImage3D:st,scissor:yt,viewport:ut,reset:se}}function kg(r,t,e,n,i,s,a){const o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new bt,u=new WeakMap;let h;const f=new WeakMap;let d=!1;try{d=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(L,A){return d?new OffscreenCanvas(L,A):Gr("canvas")}function _(L,A,Y){let $=1;const Q=te(L);if((Q.width>Y||Q.height>Y)&&($=Y/Math.max(Q.width,Q.height)),$<1)if(typeof HTMLImageElement<"u"&&L instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&L instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&L instanceof ImageBitmap||typeof VideoFrame<"u"&&L instanceof VideoFrame){const tt=Math.floor($*Q.width),_t=Math.floor($*Q.height);h===void 0&&(h=g(tt,_t));const at=A?g(tt,_t):h;return at.width=tt,at.height=_t,at.getContext("2d").drawImage(L,0,0,tt,_t),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+Q.width+"x"+Q.height+") to ("+tt+"x"+_t+")."),at}else return"data"in L&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+Q.width+"x"+Q.height+")."),L;return L}function p(L){return L.generateMipmaps&&L.minFilter!==ln&&L.minFilter!==on}function m(L){r.generateMipmap(L)}function S(L,A,Y,$,Q=!1){if(L!==null){if(r[L]!==void 0)return r[L];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+L+"'")}let tt=A;if(A===r.RED&&(Y===r.FLOAT&&(tt=r.R32F),Y===r.HALF_FLOAT&&(tt=r.R16F),Y===r.UNSIGNED_BYTE&&(tt=r.R8)),A===r.RED_INTEGER&&(Y===r.UNSIGNED_BYTE&&(tt=r.R8UI),Y===r.UNSIGNED_SHORT&&(tt=r.R16UI),Y===r.UNSIGNED_INT&&(tt=r.R32UI),Y===r.BYTE&&(tt=r.R8I),Y===r.SHORT&&(tt=r.R16I),Y===r.INT&&(tt=r.R32I)),A===r.RG&&(Y===r.FLOAT&&(tt=r.RG32F),Y===r.HALF_FLOAT&&(tt=r.RG16F),Y===r.UNSIGNED_BYTE&&(tt=r.RG8)),A===r.RG_INTEGER&&(Y===r.UNSIGNED_BYTE&&(tt=r.RG8UI),Y===r.UNSIGNED_SHORT&&(tt=r.RG16UI),Y===r.UNSIGNED_INT&&(tt=r.RG32UI),Y===r.BYTE&&(tt=r.RG8I),Y===r.SHORT&&(tt=r.RG16I),Y===r.INT&&(tt=r.RG32I)),A===r.RGB&&Y===r.UNSIGNED_INT_5_9_9_9_REV&&(tt=r.RGB9_E5),A===r.RGBA){const _t=Q?Ns:qt.getTransfer($);Y===r.FLOAT&&(tt=r.RGBA32F),Y===r.HALF_FLOAT&&(tt=r.RGBA16F),Y===r.UNSIGNED_BYTE&&(tt=_t===Jt?r.SRGB8_ALPHA8:r.RGBA8),Y===r.UNSIGNED_SHORT_4_4_4_4&&(tt=r.RGBA4),Y===r.UNSIGNED_SHORT_5_5_5_1&&(tt=r.RGB5_A1)}return(tt===r.R16F||tt===r.R32F||tt===r.RG16F||tt===r.RG32F||tt===r.RGBA16F||tt===r.RGBA32F)&&t.get("EXT_color_buffer_float"),tt}function x(L,A){let Y;return L?A===null||A===_r||A===gr?Y=r.DEPTH24_STENCIL8:A===Zn?Y=r.DEPTH32F_STENCIL8:A===Us&&(Y=r.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):A===null||A===_r||A===gr?Y=r.DEPTH_COMPONENT24:A===Zn?Y=r.DEPTH_COMPONENT32F:A===Us&&(Y=r.DEPTH_COMPONENT16),Y}function E(L,A){return p(L)===!0||L.isFramebufferTexture&&L.minFilter!==ln&&L.minFilter!==on?Math.log2(Math.max(A.width,A.height))+1:L.mipmaps!==void 0&&L.mipmaps.length>0?L.mipmaps.length:L.isCompressedTexture&&Array.isArray(L.image)?A.mipmaps.length:1}function w(L){const A=L.target;A.removeEventListener("dispose",w),T(A),A.isVideoTexture&&u.delete(A)}function b(L){const A=L.target;A.removeEventListener("dispose",b),y(A)}function T(L){const A=n.get(L);if(A.__webglInit===void 0)return;const Y=L.source,$=f.get(Y);if($){const Q=$[A.__cacheKey];Q.usedTimes--,Q.usedTimes===0&&P(L),Object.keys($).length===0&&f.delete(Y)}n.remove(L)}function P(L){const A=n.get(L);r.deleteTexture(A.__webglTexture);const Y=L.source,$=f.get(Y);delete $[A.__cacheKey],a.memory.textures--}function y(L){const A=n.get(L);if(L.depthTexture&&L.depthTexture.dispose(),L.isWebGLCubeRenderTarget)for(let $=0;$<6;$++){if(Array.isArray(A.__webglFramebuffer[$]))for(let Q=0;Q<A.__webglFramebuffer[$].length;Q++)r.deleteFramebuffer(A.__webglFramebuffer[$][Q]);else r.deleteFramebuffer(A.__webglFramebuffer[$]);A.__webglDepthbuffer&&r.deleteRenderbuffer(A.__webglDepthbuffer[$])}else{if(Array.isArray(A.__webglFramebuffer))for(let $=0;$<A.__webglFramebuffer.length;$++)r.deleteFramebuffer(A.__webglFramebuffer[$]);else r.deleteFramebuffer(A.__webglFramebuffer);if(A.__webglDepthbuffer&&r.deleteRenderbuffer(A.__webglDepthbuffer),A.__webglMultisampledFramebuffer&&r.deleteFramebuffer(A.__webglMultisampledFramebuffer),A.__webglColorRenderbuffer)for(let $=0;$<A.__webglColorRenderbuffer.length;$++)A.__webglColorRenderbuffer[$]&&r.deleteRenderbuffer(A.__webglColorRenderbuffer[$]);A.__webglDepthRenderbuffer&&r.deleteRenderbuffer(A.__webglDepthRenderbuffer)}const Y=L.textures;for(let $=0,Q=Y.length;$<Q;$++){const tt=n.get(Y[$]);tt.__webglTexture&&(r.deleteTexture(tt.__webglTexture),a.memory.textures--),n.remove(Y[$])}n.remove(L)}let M=0;function C(){M=0}function D(){const L=M;return L>=i.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+L+" texture units while this GPU supports only "+i.maxTextures),M+=1,L}function I(L){const A=[];return A.push(L.wrapS),A.push(L.wrapT),A.push(L.wrapR||0),A.push(L.magFilter),A.push(L.minFilter),A.push(L.anisotropy),A.push(L.internalFormat),A.push(L.format),A.push(L.type),A.push(L.generateMipmaps),A.push(L.premultiplyAlpha),A.push(L.flipY),A.push(L.unpackAlignment),A.push(L.colorSpace),A.join()}function N(L,A){const Y=n.get(L);if(L.isVideoTexture&&Ot(L),L.isRenderTargetTexture===!1&&L.version>0&&Y.__version!==L.version){const $=L.image;if($===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if($.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Dt(Y,L,A);return}}e.bindTexture(r.TEXTURE_2D,Y.__webglTexture,r.TEXTURE0+A)}function k(L,A){const Y=n.get(L);if(L.version>0&&Y.__version!==L.version){Dt(Y,L,A);return}e.bindTexture(r.TEXTURE_2D_ARRAY,Y.__webglTexture,r.TEXTURE0+A)}function O(L,A){const Y=n.get(L);if(L.version>0&&Y.__version!==L.version){Dt(Y,L,A);return}e.bindTexture(r.TEXTURE_3D,Y.__webglTexture,r.TEXTURE0+A)}function G(L,A){const Y=n.get(L);if(L.version>0&&Y.__version!==L.version){K(Y,L,A);return}e.bindTexture(r.TEXTURE_CUBE_MAP,Y.__webglTexture,r.TEXTURE0+A)}const z={[ro]:r.REPEAT,[Ri]:r.CLAMP_TO_EDGE,[so]:r.MIRRORED_REPEAT},et={[ln]:r.NEAREST,[Mf]:r.NEAREST_MIPMAP_NEAREST,[ns]:r.NEAREST_MIPMAP_LINEAR,[on]:r.LINEAR,[la]:r.LINEAR_MIPMAP_NEAREST,[$n]:r.LINEAR_MIPMAP_LINEAR},nt={[Uf]:r.NEVER,[kf]:r.ALWAYS,[Nf]:r.LESS,[hu]:r.LEQUAL,[Of]:r.EQUAL,[zf]:r.GEQUAL,[Ff]:r.GREATER,[Bf]:r.NOTEQUAL};function lt(L,A){if(A.type===Zn&&t.has("OES_texture_float_linear")===!1&&(A.magFilter===on||A.magFilter===la||A.magFilter===ns||A.magFilter===$n||A.minFilter===on||A.minFilter===la||A.minFilter===ns||A.minFilter===$n)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),r.texParameteri(L,r.TEXTURE_WRAP_S,z[A.wrapS]),r.texParameteri(L,r.TEXTURE_WRAP_T,z[A.wrapT]),(L===r.TEXTURE_3D||L===r.TEXTURE_2D_ARRAY)&&r.texParameteri(L,r.TEXTURE_WRAP_R,z[A.wrapR]),r.texParameteri(L,r.TEXTURE_MAG_FILTER,et[A.magFilter]),r.texParameteri(L,r.TEXTURE_MIN_FILTER,et[A.minFilter]),A.compareFunction&&(r.texParameteri(L,r.TEXTURE_COMPARE_MODE,r.COMPARE_REF_TO_TEXTURE),r.texParameteri(L,r.TEXTURE_COMPARE_FUNC,nt[A.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(A.magFilter===ln||A.minFilter!==ns&&A.minFilter!==$n||A.type===Zn&&t.has("OES_texture_float_linear")===!1)return;if(A.anisotropy>1||n.get(A).__currentAnisotropy){const Y=t.get("EXT_texture_filter_anisotropic");r.texParameterf(L,Y.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(A.anisotropy,i.getMaxAnisotropy())),n.get(A).__currentAnisotropy=A.anisotropy}}}function Mt(L,A){let Y=!1;L.__webglInit===void 0&&(L.__webglInit=!0,A.addEventListener("dispose",w));const $=A.source;let Q=f.get($);Q===void 0&&(Q={},f.set($,Q));const tt=I(A);if(tt!==L.__cacheKey){Q[tt]===void 0&&(Q[tt]={texture:r.createTexture(),usedTimes:0},a.memory.textures++,Y=!0),Q[tt].usedTimes++;const _t=Q[L.__cacheKey];_t!==void 0&&(Q[L.__cacheKey].usedTimes--,_t.usedTimes===0&&P(A)),L.__cacheKey=tt,L.__webglTexture=Q[tt].texture}return Y}function Dt(L,A,Y){let $=r.TEXTURE_2D;(A.isDataArrayTexture||A.isCompressedArrayTexture)&&($=r.TEXTURE_2D_ARRAY),A.isData3DTexture&&($=r.TEXTURE_3D);const Q=Mt(L,A),tt=A.source;e.bindTexture($,L.__webglTexture,r.TEXTURE0+Y);const _t=n.get(tt);if(tt.version!==_t.__version||Q===!0){e.activeTexture(r.TEXTURE0+Y);const at=qt.getPrimaries(qt.workingColorSpace),st=A.colorSpace===Fn?null:qt.getPrimaries(A.colorSpace),Ct=A.colorSpace===Fn||at===st?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,A.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,A.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,A.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ct);let it=_(A.image,!1,i.maxTextureSize);it=Rt(A,it);const pt=s.convert(A.format,A.colorSpace),Ft=s.convert(A.type);let yt=S(A.internalFormat,pt,Ft,A.colorSpace,A.isVideoTexture);lt($,A);let ut;const Pt=A.mipmaps,Lt=A.isVideoTexture!==!0,se=_t.__version===void 0||Q===!0,v=tt.dataReady,q=E(A,it);if(A.isDepthTexture)yt=x(A.format===vr,A.type),se&&(Lt?e.texStorage2D(r.TEXTURE_2D,1,yt,it.width,it.height):e.texImage2D(r.TEXTURE_2D,0,yt,it.width,it.height,0,pt,Ft,null));else if(A.isDataTexture)if(Pt.length>0){Lt&&se&&e.texStorage2D(r.TEXTURE_2D,q,yt,Pt[0].width,Pt[0].height);for(let V=0,j=Pt.length;V<j;V++)ut=Pt[V],Lt?v&&e.texSubImage2D(r.TEXTURE_2D,V,0,0,ut.width,ut.height,pt,Ft,ut.data):e.texImage2D(r.TEXTURE_2D,V,yt,ut.width,ut.height,0,pt,Ft,ut.data);A.generateMipmaps=!1}else Lt?(se&&e.texStorage2D(r.TEXTURE_2D,q,yt,it.width,it.height),v&&e.texSubImage2D(r.TEXTURE_2D,0,0,0,it.width,it.height,pt,Ft,it.data)):e.texImage2D(r.TEXTURE_2D,0,yt,it.width,it.height,0,pt,Ft,it.data);else if(A.isCompressedTexture)if(A.isCompressedArrayTexture){Lt&&se&&e.texStorage3D(r.TEXTURE_2D_ARRAY,q,yt,Pt[0].width,Pt[0].height,it.depth);for(let V=0,j=Pt.length;V<j;V++)if(ut=Pt[V],A.format!==yn)if(pt!==null)if(Lt){if(v)if(A.layerUpdates.size>0){for(const J of A.layerUpdates){const gt=ut.width*ut.height;e.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,V,0,0,J,ut.width,ut.height,1,pt,ut.data.slice(gt*J,gt*(J+1)),0,0)}A.clearLayerUpdates()}else e.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,V,0,0,0,ut.width,ut.height,it.depth,pt,ut.data,0,0)}else e.compressedTexImage3D(r.TEXTURE_2D_ARRAY,V,yt,ut.width,ut.height,it.depth,0,ut.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Lt?v&&e.texSubImage3D(r.TEXTURE_2D_ARRAY,V,0,0,0,ut.width,ut.height,it.depth,pt,Ft,ut.data):e.texImage3D(r.TEXTURE_2D_ARRAY,V,yt,ut.width,ut.height,it.depth,0,pt,Ft,ut.data)}else{Lt&&se&&e.texStorage2D(r.TEXTURE_2D,q,yt,Pt[0].width,Pt[0].height);for(let V=0,j=Pt.length;V<j;V++)ut=Pt[V],A.format!==yn?pt!==null?Lt?v&&e.compressedTexSubImage2D(r.TEXTURE_2D,V,0,0,ut.width,ut.height,pt,ut.data):e.compressedTexImage2D(r.TEXTURE_2D,V,yt,ut.width,ut.height,0,ut.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Lt?v&&e.texSubImage2D(r.TEXTURE_2D,V,0,0,ut.width,ut.height,pt,Ft,ut.data):e.texImage2D(r.TEXTURE_2D,V,yt,ut.width,ut.height,0,pt,Ft,ut.data)}else if(A.isDataArrayTexture)if(Lt){if(se&&e.texStorage3D(r.TEXTURE_2D_ARRAY,q,yt,it.width,it.height,it.depth),v)if(A.layerUpdates.size>0){let V;switch(Ft){case r.UNSIGNED_BYTE:switch(pt){case r.ALPHA:V=1;break;case r.LUMINANCE:V=1;break;case r.LUMINANCE_ALPHA:V=2;break;case r.RGB:V=3;break;case r.RGBA:V=4;break;default:throw new Error(`Unknown texel size for format ${pt}.`)}break;case r.UNSIGNED_SHORT_4_4_4_4:case r.UNSIGNED_SHORT_5_5_5_1:case r.UNSIGNED_SHORT_5_6_5:V=1;break;default:throw new Error(`Unknown texel size for type ${Ft}.`)}const j=it.width*it.height*V;for(const J of A.layerUpdates)e.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,J,it.width,it.height,1,pt,Ft,it.data.slice(j*J,j*(J+1)));A.clearLayerUpdates()}else e.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,0,it.width,it.height,it.depth,pt,Ft,it.data)}else e.texImage3D(r.TEXTURE_2D_ARRAY,0,yt,it.width,it.height,it.depth,0,pt,Ft,it.data);else if(A.isData3DTexture)Lt?(se&&e.texStorage3D(r.TEXTURE_3D,q,yt,it.width,it.height,it.depth),v&&e.texSubImage3D(r.TEXTURE_3D,0,0,0,0,it.width,it.height,it.depth,pt,Ft,it.data)):e.texImage3D(r.TEXTURE_3D,0,yt,it.width,it.height,it.depth,0,pt,Ft,it.data);else if(A.isFramebufferTexture){if(se)if(Lt)e.texStorage2D(r.TEXTURE_2D,q,yt,it.width,it.height);else{let V=it.width,j=it.height;for(let J=0;J<q;J++)e.texImage2D(r.TEXTURE_2D,J,yt,V,j,0,pt,Ft,null),V>>=1,j>>=1}}else if(Pt.length>0){if(Lt&&se){const V=te(Pt[0]);e.texStorage2D(r.TEXTURE_2D,q,yt,V.width,V.height)}for(let V=0,j=Pt.length;V<j;V++)ut=Pt[V],Lt?v&&e.texSubImage2D(r.TEXTURE_2D,V,0,0,pt,Ft,ut):e.texImage2D(r.TEXTURE_2D,V,yt,pt,Ft,ut);A.generateMipmaps=!1}else if(Lt){if(se){const V=te(it);e.texStorage2D(r.TEXTURE_2D,q,yt,V.width,V.height)}v&&e.texSubImage2D(r.TEXTURE_2D,0,0,0,pt,Ft,it)}else e.texImage2D(r.TEXTURE_2D,0,yt,pt,Ft,it);p(A)&&m($),_t.__version=tt.version,A.onUpdate&&A.onUpdate(A)}L.__version=A.version}function K(L,A,Y){if(A.image.length!==6)return;const $=Mt(L,A),Q=A.source;e.bindTexture(r.TEXTURE_CUBE_MAP,L.__webglTexture,r.TEXTURE0+Y);const tt=n.get(Q);if(Q.version!==tt.__version||$===!0){e.activeTexture(r.TEXTURE0+Y);const _t=qt.getPrimaries(qt.workingColorSpace),at=A.colorSpace===Fn?null:qt.getPrimaries(A.colorSpace),st=A.colorSpace===Fn||_t===at?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,A.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,A.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,A.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,st);const Ct=A.isCompressedTexture||A.image[0].isCompressedTexture,it=A.image[0]&&A.image[0].isDataTexture,pt=[];for(let j=0;j<6;j++)!Ct&&!it?pt[j]=_(A.image[j],!0,i.maxCubemapSize):pt[j]=it?A.image[j].image:A.image[j],pt[j]=Rt(A,pt[j]);const Ft=pt[0],yt=s.convert(A.format,A.colorSpace),ut=s.convert(A.type),Pt=S(A.internalFormat,yt,ut,A.colorSpace),Lt=A.isVideoTexture!==!0,se=tt.__version===void 0||$===!0,v=Q.dataReady;let q=E(A,Ft);lt(r.TEXTURE_CUBE_MAP,A);let V;if(Ct){Lt&&se&&e.texStorage2D(r.TEXTURE_CUBE_MAP,q,Pt,Ft.width,Ft.height);for(let j=0;j<6;j++){V=pt[j].mipmaps;for(let J=0;J<V.length;J++){const gt=V[J];A.format!==yn?yt!==null?Lt?v&&e.compressedTexSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+j,J,0,0,gt.width,gt.height,yt,gt.data):e.compressedTexImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+j,J,Pt,gt.width,gt.height,0,gt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Lt?v&&e.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+j,J,0,0,gt.width,gt.height,yt,ut,gt.data):e.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+j,J,Pt,gt.width,gt.height,0,yt,ut,gt.data)}}}else{if(V=A.mipmaps,Lt&&se){V.length>0&&q++;const j=te(pt[0]);e.texStorage2D(r.TEXTURE_CUBE_MAP,q,Pt,j.width,j.height)}for(let j=0;j<6;j++)if(it){Lt?v&&e.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,pt[j].width,pt[j].height,yt,ut,pt[j].data):e.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,Pt,pt[j].width,pt[j].height,0,yt,ut,pt[j].data);for(let J=0;J<V.length;J++){const At=V[J].image[j].image;Lt?v&&e.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+j,J+1,0,0,At.width,At.height,yt,ut,At.data):e.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+j,J+1,Pt,At.width,At.height,0,yt,ut,At.data)}}else{Lt?v&&e.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,yt,ut,pt[j]):e.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,Pt,yt,ut,pt[j]);for(let J=0;J<V.length;J++){const gt=V[J];Lt?v&&e.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+j,J+1,0,0,yt,ut,gt.image[j]):e.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+j,J+1,Pt,yt,ut,gt.image[j])}}}p(A)&&m(r.TEXTURE_CUBE_MAP),tt.__version=Q.version,A.onUpdate&&A.onUpdate(A)}L.__version=A.version}function Z(L,A,Y,$,Q,tt){const _t=s.convert(Y.format,Y.colorSpace),at=s.convert(Y.type),st=S(Y.internalFormat,_t,at,Y.colorSpace);if(!n.get(A).__hasExternalTextures){const it=Math.max(1,A.width>>tt),pt=Math.max(1,A.height>>tt);Q===r.TEXTURE_3D||Q===r.TEXTURE_2D_ARRAY?e.texImage3D(Q,tt,st,it,pt,A.depth,0,_t,at,null):e.texImage2D(Q,tt,st,it,pt,0,_t,at,null)}e.bindFramebuffer(r.FRAMEBUFFER,L),Gt(A)?o.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,$,Q,n.get(Y).__webglTexture,0,xt(A)):(Q===r.TEXTURE_2D||Q>=r.TEXTURE_CUBE_MAP_POSITIVE_X&&Q<=r.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&r.framebufferTexture2D(r.FRAMEBUFFER,$,Q,n.get(Y).__webglTexture,tt),e.bindFramebuffer(r.FRAMEBUFFER,null)}function ft(L,A,Y){if(r.bindRenderbuffer(r.RENDERBUFFER,L),A.depthBuffer){const $=A.depthTexture,Q=$&&$.isDepthTexture?$.type:null,tt=x(A.stencilBuffer,Q),_t=A.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,at=xt(A);Gt(A)?o.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,at,tt,A.width,A.height):Y?r.renderbufferStorageMultisample(r.RENDERBUFFER,at,tt,A.width,A.height):r.renderbufferStorage(r.RENDERBUFFER,tt,A.width,A.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,_t,r.RENDERBUFFER,L)}else{const $=A.textures;for(let Q=0;Q<$.length;Q++){const tt=$[Q],_t=s.convert(tt.format,tt.colorSpace),at=s.convert(tt.type),st=S(tt.internalFormat,_t,at,tt.colorSpace),Ct=xt(A);Y&&Gt(A)===!1?r.renderbufferStorageMultisample(r.RENDERBUFFER,Ct,st,A.width,A.height):Gt(A)?o.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,Ct,st,A.width,A.height):r.renderbufferStorage(r.RENDERBUFFER,st,A.width,A.height)}}r.bindRenderbuffer(r.RENDERBUFFER,null)}function ct(L,A){if(A&&A.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(r.FRAMEBUFFER,L),!(A.depthTexture&&A.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!n.get(A.depthTexture).__webglTexture||A.depthTexture.image.width!==A.width||A.depthTexture.image.height!==A.height)&&(A.depthTexture.image.width=A.width,A.depthTexture.image.height=A.height,A.depthTexture.needsUpdate=!0),N(A.depthTexture,0);const $=n.get(A.depthTexture).__webglTexture,Q=xt(A);if(A.depthTexture.format===cr)Gt(A)?o.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.TEXTURE_2D,$,0,Q):r.framebufferTexture2D(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.TEXTURE_2D,$,0);else if(A.depthTexture.format===vr)Gt(A)?o.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,r.DEPTH_STENCIL_ATTACHMENT,r.TEXTURE_2D,$,0,Q):r.framebufferTexture2D(r.FRAMEBUFFER,r.DEPTH_STENCIL_ATTACHMENT,r.TEXTURE_2D,$,0);else throw new Error("Unknown depthTexture format")}function Nt(L){const A=n.get(L),Y=L.isWebGLCubeRenderTarget===!0;if(L.depthTexture&&!A.__autoAllocateDepthBuffer){if(Y)throw new Error("target.depthTexture not supported in Cube render targets");ct(A.__webglFramebuffer,L)}else if(Y){A.__webglDepthbuffer=[];for(let $=0;$<6;$++)e.bindFramebuffer(r.FRAMEBUFFER,A.__webglFramebuffer[$]),A.__webglDepthbuffer[$]=r.createRenderbuffer(),ft(A.__webglDepthbuffer[$],L,!1)}else e.bindFramebuffer(r.FRAMEBUFFER,A.__webglFramebuffer),A.__webglDepthbuffer=r.createRenderbuffer(),ft(A.__webglDepthbuffer,L,!1);e.bindFramebuffer(r.FRAMEBUFFER,null)}function wt(L,A,Y){const $=n.get(L);A!==void 0&&Z($.__webglFramebuffer,L,L.texture,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,0),Y!==void 0&&Nt(L)}function kt(L){const A=L.texture,Y=n.get(L),$=n.get(A);L.addEventListener("dispose",b);const Q=L.textures,tt=L.isWebGLCubeRenderTarget===!0,_t=Q.length>1;if(_t||($.__webglTexture===void 0&&($.__webglTexture=r.createTexture()),$.__version=A.version,a.memory.textures++),tt){Y.__webglFramebuffer=[];for(let at=0;at<6;at++)if(A.mipmaps&&A.mipmaps.length>0){Y.__webglFramebuffer[at]=[];for(let st=0;st<A.mipmaps.length;st++)Y.__webglFramebuffer[at][st]=r.createFramebuffer()}else Y.__webglFramebuffer[at]=r.createFramebuffer()}else{if(A.mipmaps&&A.mipmaps.length>0){Y.__webglFramebuffer=[];for(let at=0;at<A.mipmaps.length;at++)Y.__webglFramebuffer[at]=r.createFramebuffer()}else Y.__webglFramebuffer=r.createFramebuffer();if(_t)for(let at=0,st=Q.length;at<st;at++){const Ct=n.get(Q[at]);Ct.__webglTexture===void 0&&(Ct.__webglTexture=r.createTexture(),a.memory.textures++)}if(L.samples>0&&Gt(L)===!1){Y.__webglMultisampledFramebuffer=r.createFramebuffer(),Y.__webglColorRenderbuffer=[],e.bindFramebuffer(r.FRAMEBUFFER,Y.__webglMultisampledFramebuffer);for(let at=0;at<Q.length;at++){const st=Q[at];Y.__webglColorRenderbuffer[at]=r.createRenderbuffer(),r.bindRenderbuffer(r.RENDERBUFFER,Y.__webglColorRenderbuffer[at]);const Ct=s.convert(st.format,st.colorSpace),it=s.convert(st.type),pt=S(st.internalFormat,Ct,it,st.colorSpace,L.isXRRenderTarget===!0),Ft=xt(L);r.renderbufferStorageMultisample(r.RENDERBUFFER,Ft,pt,L.width,L.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+at,r.RENDERBUFFER,Y.__webglColorRenderbuffer[at])}r.bindRenderbuffer(r.RENDERBUFFER,null),L.depthBuffer&&(Y.__webglDepthRenderbuffer=r.createRenderbuffer(),ft(Y.__webglDepthRenderbuffer,L,!0)),e.bindFramebuffer(r.FRAMEBUFFER,null)}}if(tt){e.bindTexture(r.TEXTURE_CUBE_MAP,$.__webglTexture),lt(r.TEXTURE_CUBE_MAP,A);for(let at=0;at<6;at++)if(A.mipmaps&&A.mipmaps.length>0)for(let st=0;st<A.mipmaps.length;st++)Z(Y.__webglFramebuffer[at][st],L,A,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+at,st);else Z(Y.__webglFramebuffer[at],L,A,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+at,0);p(A)&&m(r.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(_t){for(let at=0,st=Q.length;at<st;at++){const Ct=Q[at],it=n.get(Ct);e.bindTexture(r.TEXTURE_2D,it.__webglTexture),lt(r.TEXTURE_2D,Ct),Z(Y.__webglFramebuffer,L,Ct,r.COLOR_ATTACHMENT0+at,r.TEXTURE_2D,0),p(Ct)&&m(r.TEXTURE_2D)}e.unbindTexture()}else{let at=r.TEXTURE_2D;if((L.isWebGL3DRenderTarget||L.isWebGLArrayRenderTarget)&&(at=L.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),e.bindTexture(at,$.__webglTexture),lt(at,A),A.mipmaps&&A.mipmaps.length>0)for(let st=0;st<A.mipmaps.length;st++)Z(Y.__webglFramebuffer[st],L,A,r.COLOR_ATTACHMENT0,at,st);else Z(Y.__webglFramebuffer,L,A,r.COLOR_ATTACHMENT0,at,0);p(A)&&m(at),e.unbindTexture()}L.depthBuffer&&Nt(L)}function U(L){const A=L.textures;for(let Y=0,$=A.length;Y<$;Y++){const Q=A[Y];if(p(Q)){const tt=L.isWebGLCubeRenderTarget?r.TEXTURE_CUBE_MAP:r.TEXTURE_2D,_t=n.get(Q).__webglTexture;e.bindTexture(tt,_t),m(tt),e.unbindTexture()}}}const Ht=[],zt=[];function Zt(L){if(L.samples>0){if(Gt(L)===!1){const A=L.textures,Y=L.width,$=L.height;let Q=r.COLOR_BUFFER_BIT;const tt=L.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,_t=n.get(L),at=A.length>1;if(at)for(let st=0;st<A.length;st++)e.bindFramebuffer(r.FRAMEBUFFER,_t.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+st,r.RENDERBUFFER,null),e.bindFramebuffer(r.FRAMEBUFFER,_t.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+st,r.TEXTURE_2D,null,0);e.bindFramebuffer(r.READ_FRAMEBUFFER,_t.__webglMultisampledFramebuffer),e.bindFramebuffer(r.DRAW_FRAMEBUFFER,_t.__webglFramebuffer);for(let st=0;st<A.length;st++){if(L.resolveDepthBuffer&&(L.depthBuffer&&(Q|=r.DEPTH_BUFFER_BIT),L.stencilBuffer&&L.resolveStencilBuffer&&(Q|=r.STENCIL_BUFFER_BIT)),at){r.framebufferRenderbuffer(r.READ_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.RENDERBUFFER,_t.__webglColorRenderbuffer[st]);const Ct=n.get(A[st]).__webglTexture;r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,Ct,0)}r.blitFramebuffer(0,0,Y,$,0,0,Y,$,Q,r.NEAREST),l===!0&&(Ht.length=0,zt.length=0,Ht.push(r.COLOR_ATTACHMENT0+st),L.depthBuffer&&L.resolveDepthBuffer===!1&&(Ht.push(tt),zt.push(tt),r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,zt)),r.invalidateFramebuffer(r.READ_FRAMEBUFFER,Ht))}if(e.bindFramebuffer(r.READ_FRAMEBUFFER,null),e.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),at)for(let st=0;st<A.length;st++){e.bindFramebuffer(r.FRAMEBUFFER,_t.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+st,r.RENDERBUFFER,_t.__webglColorRenderbuffer[st]);const Ct=n.get(A[st]).__webglTexture;e.bindFramebuffer(r.FRAMEBUFFER,_t.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+st,r.TEXTURE_2D,Ct,0)}e.bindFramebuffer(r.DRAW_FRAMEBUFFER,_t.__webglMultisampledFramebuffer)}else if(L.depthBuffer&&L.resolveDepthBuffer===!1&&l){const A=L.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,[A])}}}function xt(L){return Math.min(i.maxSamples,L.samples)}function Gt(L){const A=n.get(L);return L.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&A.__useRenderToTexture!==!1}function Ot(L){const A=a.render.frame;u.get(L)!==A&&(u.set(L,A),L.update())}function Rt(L,A){const Y=L.colorSpace,$=L.format,Q=L.type;return L.isCompressedTexture===!0||L.isVideoTexture===!0||Y!==hi&&Y!==Fn&&(qt.getTransfer(Y)===Jt?($!==yn||Q!==ai)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",Y)),A}function te(L){return typeof HTMLImageElement<"u"&&L instanceof HTMLImageElement?(c.width=L.naturalWidth||L.width,c.height=L.naturalHeight||L.height):typeof VideoFrame<"u"&&L instanceof VideoFrame?(c.width=L.displayWidth,c.height=L.displayHeight):(c.width=L.width,c.height=L.height),c}this.allocateTextureUnit=D,this.resetTextureUnits=C,this.setTexture2D=N,this.setTexture2DArray=k,this.setTexture3D=O,this.setTextureCube=G,this.rebindTextures=wt,this.setupRenderTarget=kt,this.updateRenderTargetMipmap=U,this.updateMultisampleRenderTarget=Zt,this.setupDepthRenderbuffer=Nt,this.setupFrameBufferTexture=Z,this.useMultisampledRTT=Gt}function Hg(r,t){function e(n,i=Fn){let s;const a=qt.getTransfer(i);if(n===ai)return r.UNSIGNED_BYTE;if(n===au)return r.UNSIGNED_SHORT_4_4_4_4;if(n===ou)return r.UNSIGNED_SHORT_5_5_5_1;if(n===Ef)return r.UNSIGNED_INT_5_9_9_9_REV;if(n===Sf)return r.BYTE;if(n===yf)return r.SHORT;if(n===Us)return r.UNSIGNED_SHORT;if(n===su)return r.INT;if(n===_r)return r.UNSIGNED_INT;if(n===Zn)return r.FLOAT;if(n===Zs)return r.HALF_FLOAT;if(n===Tf)return r.ALPHA;if(n===bf)return r.RGB;if(n===yn)return r.RGBA;if(n===Af)return r.LUMINANCE;if(n===wf)return r.LUMINANCE_ALPHA;if(n===cr)return r.DEPTH_COMPONENT;if(n===vr)return r.DEPTH_STENCIL;if(n===Rf)return r.RED;if(n===lu)return r.RED_INTEGER;if(n===Cf)return r.RG;if(n===cu)return r.RG_INTEGER;if(n===uu)return r.RGBA_INTEGER;if(n===ca||n===ua||n===ha||n===fa)if(a===Jt)if(s=t.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===ca)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===ua)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===ha)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===fa)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=t.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===ca)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===ua)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===ha)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===fa)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===al||n===ol||n===ll||n===cl)if(s=t.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===al)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===ol)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===ll)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===cl)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===ul||n===hl||n===fl)if(s=t.get("WEBGL_compressed_texture_etc"),s!==null){if(n===ul||n===hl)return a===Jt?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===fl)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===dl||n===pl||n===ml||n===_l||n===gl||n===vl||n===xl||n===Ml||n===Sl||n===yl||n===El||n===Tl||n===bl||n===Al)if(s=t.get("WEBGL_compressed_texture_astc"),s!==null){if(n===dl)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===pl)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===ml)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===_l)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===gl)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===vl)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===xl)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Ml)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Sl)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===yl)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===El)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Tl)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===bl)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Al)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===da||n===wl||n===Rl)if(s=t.get("EXT_texture_compression_bptc"),s!==null){if(n===da)return a===Jt?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===wl)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Rl)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Pf||n===Cl||n===Pl||n===Ll)if(s=t.get("EXT_texture_compression_rgtc"),s!==null){if(n===da)return s.COMPRESSED_RED_RGTC1_EXT;if(n===Cl)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Pl)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Ll)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===gr?r.UNSIGNED_INT_24_8:r[n]!==void 0?r[n]:null}return{convert:e}}class Gg extends an{constructor(t=[]){super(),this.isArrayCamera=!0,this.cameras=t}}class Mn extends ye{constructor(){super(),this.isGroup=!0,this.type="Group"}}const Vg={type:"move"};class za{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Mn,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Mn,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new F,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new F),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Mn,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new F,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new F),this._grip}dispatchEvent(t){return this._targetRay!==null&&this._targetRay.dispatchEvent(t),this._grip!==null&&this._grip.dispatchEvent(t),this._hand!==null&&this._hand.dispatchEvent(t),this}connect(t){if(t&&t.hand){const e=this._hand;if(e)for(const n of t.hand.values())this._getHandJoint(e,n)}return this.dispatchEvent({type:"connected",data:t}),this}disconnect(t){return this.dispatchEvent({type:"disconnected",data:t}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(t,e,n){let i=null,s=null,a=null;const o=this._targetRay,l=this._grip,c=this._hand;if(t&&e.session.visibilityState!=="visible-blurred"){if(c&&t.hand){a=!0;for(const _ of t.hand.values()){const p=e.getJointPose(_,n),m=this._getHandJoint(c,_);p!==null&&(m.matrix.fromArray(p.transform.matrix),m.matrix.decompose(m.position,m.rotation,m.scale),m.matrixWorldNeedsUpdate=!0,m.jointRadius=p.radius),m.visible=p!==null}const u=c.joints["index-finger-tip"],h=c.joints["thumb-tip"],f=u.position.distanceTo(h.position),d=.02,g=.005;c.inputState.pinching&&f>d+g?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:t.handedness,target:this})):!c.inputState.pinching&&f<=d-g&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:t.handedness,target:this}))}else l!==null&&t.gripSpace&&(s=e.getPose(t.gripSpace,n),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));o!==null&&(i=e.getPose(t.targetRaySpace,n),i===null&&s!==null&&(i=s),i!==null&&(o.matrix.fromArray(i.transform.matrix),o.matrix.decompose(o.position,o.rotation,o.scale),o.matrixWorldNeedsUpdate=!0,i.linearVelocity?(o.hasLinearVelocity=!0,o.linearVelocity.copy(i.linearVelocity)):o.hasLinearVelocity=!1,i.angularVelocity?(o.hasAngularVelocity=!0,o.angularVelocity.copy(i.angularVelocity)):o.hasAngularVelocity=!1,this.dispatchEvent(Vg)))}return o!==null&&(o.visible=i!==null),l!==null&&(l.visible=s!==null),c!==null&&(c.visible=a!==null),this}_getHandJoint(t,e){if(t.joints[e.jointName]===void 0){const n=new Mn;n.matrixAutoUpdate=!1,n.visible=!1,t.joints[e.jointName]=n,t.add(n)}return t.joints[e.jointName]}}const Wg=`
void main() {
 ...
 * Subject to the terms at https://gsap.com/standard-license
 * @author: Jack Doyle, jack@greensock.com
*/var qc,Qn,fr,Ko,Ci,jc,$o,Mv=function(){return typeof window<"u"},kn={},bi=180/Math.PI,dr=Math.PI/180,rr=Math.atan2,Kc=1e8,Zo=/([A-Z])/g,Sv=/(left|right|width|margin|padding|x)/i,yv=/[\s,\(]\S/,En={autoAlpha:"opacity,visibility",scale:"scaleX,scaleY",alpha:"opacity"},Mo=function(t,e){return e.set(e.t,e.p,Math.round((e.s+e.c*t)*1e4)/1e4+e.u,e)},Ev=function(t,e){return e.set(e.t,e.p,t===1?e.e:Math.round((e.s+e.c*t)*1e4)/1e4+e.u,e)},Tv=function(t,e){return e.set(e.t,e.p,t?Math.round((e.s+e.c*t)*1e4)/1e4+e.u:e.b,e)},bv=function(t,e){return e.set(e.t,e.p,t===1?e.e:t?Math.round((e.s+e.c*t)*1e4)/1e4+e.u:e.b,e)},Av=function(t,e){var n=e.s+e.c*t;e.set(e.t,e.p,~~(n+(n<0?-.5:.5))+e.u,e)},Sh=function(t,e){return e.set(e.t,e.p,t?e.e:e.b,e)},yh=function(t,e){return e.set(e.t,e.p,t!==1?e.b:e.e,e)},wv=function(t,e,n){return t.style[e]=n},Rv=function(t,e,n){return t.style.setProperty(e,n)},Cv=function(t,e,n){return t._gsap[e]=n},Pv=function(t,e,n){return t._gsap.scaleX=t._gsap.scaleY=n},Lv=function(t,e,n,i,s){var a=t._gsap;a.scaleX=a.scaleY=n,a.renderTransform(s,a)},Dv=function(t,e,n,i,s){var a=t._gsap;a[e]=n,a.renderTransform(s,a)},ie="transform",Ge=ie+"Origin",Iv=function r(t,e){var n=this,i=this.target,s=i.style,a=i._gsap;if(t in kn&&s){if(this.tfm=this.tfm||{},t!=="transform")t=En[t]||t,~t.indexOf(",")?t.split(",").forEach(function(o){return n.tfm[o]=Nn(i,o)}):this.tfm[t]=a.x?a[t]:Nn(i,t),t===Ge&&(this.tfm.zOrigin=a.zOrigin);else return En.transform.split(",").forEach(function(o){return r.call(n,o,e)});if(this.props.indexOf(ie)>=0)return;a.svg&&(this.svgo=i.getAttribute("data-svg-origin"),this.props.push(Ge,e,"")),t=ie}(s||e)&&this.props.push(t,e,s[t])},Eh=function(t){t.translate&&(t.removeProperty("translate"),t.removeProperty("scale"),t.removeProperty("rotate"))},Uv=function(){var t=this.props,e=this.target,n=e.style,i=e._gsap,s,a;for(s=0;s<t.length;s+=3)t[s+1]?t[s+1]===2?e[t[s]](t[s+2]):e[t[s]]=t[s+2]:t[s+2]?n[t[s]]=t[s+2]:n.removeProperty(t[s].substr(0,2)==="--"?t[s]:t[s].replace(Zo,"-$1").toLowerCase());if(this.tfm){for(a in this.tfm)i[a]=this.tfm[a];i.svg&&(i.renderTransform(),e.setAttribute("data-svg-origin",this.svgo||"")),s=$o(),(!s||!s.isStart)&&!n[ie]&&(Eh(n),i.zOrigin&&n[Ge]&&(n[Ge]+=" "+i.zOrigin+"px",i.zOrigin=0,i.renderTransform()),i.uncache=1)}},Th=function(t,e){var n={target:t,props:[],revert:Uv,save:Iv};return t._gsap||Ve.core.getCache(t),e&&t.style&&t.nodeType&&e.split(",").forEach(function(i){return n.save(i)}),n},bh,So=function(t,e){var n=Qn.createElementNS?Qn.createElementNS((e||"http://www.w3.org/1999/xhtml").replace(/^https/,"http"),t):Qn.createElement(t);return n&&n.style?n:Qn.createElement(t)},Je=function r(t,e,n){var i=getComputedStyle(t);return i[e]||i.getPropertyValue(e.replace(Zo,"-$1").toLowerCase())||i.getPropertyValue(e)||!n&&r(t,br(e)||e,1)||""},$c="O,Moz,ms,Ms,Webkit".split(","),br=function(t,e,n){var i=e||Ci,s=i.style,a=5;if(t in s&&!n)return t;for(t=t.charAt(0).toUpperCase()+t.substr(1);a--&&!($c[a]+t in s););return a<0?null:(a===3?"ms":a>=0?$c[a]:"")+t},yo=function(){Mv()&&window.document&&(qc=window,Qn=qc.document,fr=Qn.documentElement,Ci=So("div")||{style:{}},So("div"),ie=br(ie),Ge=ie+"Origin",Ci.style.cssText="border-width:0;line-height:0;position:absolute;padding:0",bh=!!br("perspective"),$o=Ve.core.reverting,Ko=1)},Zc=function(t){var e=t.ownerSVGElement,n=So("svg",e&&e.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),i=t.cloneNode(!0),s;i.style.display="block",n.appendChild(i),fr.appendChild(n);try{s=i.getBBox()}catch{}return n.removeChild(i),fr.removeChild(n),s},Jc=function(t,e){for(var n=e.length;n--;)if(t.hasAttribute(e[n]))return t.getAttribute(e[n])},Ah=function(t){var e,n;try{e=t.getBBox()}catch{e=Zc(t),n=1}return e&&(e.width||e.height)||n||(e=Zc(t)),e&&!e.width&&!e.x&&!e.y?{x:+Jc(t,["x","cx","x1"])||0,y:+Jc(t,["y","cy","y1"])||0,width:0,height:0}:e},wh=function(t){return!!(t.getCTM&&(!t.parentNode||t.ownerSVGElement)&&Ah(t))},ci=function(t,e){if(e){var n=t.style,i;e in kn&&e!==Ge&&(e=ie),n.removeProperty?(i=e.substr(0,2),(i==="ms"||e.substr(0,6)==="webkit")&&(e="-"+e),n.removeProperty(i==="--"?e:e.replace(Zo,"-$1").toLowerCase())):n.removeAttribute(e)}},ti=function(t,e,n,i,s,a){var o=new He(t._pt,e,n,0,1,a?yh:Sh);return t._pt=o,o.b=i,o.e=s,t._props.push(n),o},Qc={deg:1,rad:1,turn:1},Nv={grid:1,flex:1},ui=function r(t,e,n,i){var s=parseFloat(n)||0,a=(n+"").trim().substr((s+"").length)||"px",o=Ci.style,l=Sv.test(e),c=t.tagName.toLowerCase()==="svg",u=(c?"client":"offset")+(l?"Width":"Height"),h=100,f=i==="px",d=i==="%",g,_,p,m;if(i===a||!s||Qc[i]||Qc[a])return s;if(a!=="px"&&!f&&(s=r(t,e,n,"px")),m=t.getCTM&&wh(t),(d||a==="%")&&(kn[e]||~e.indexOf("adius")))return g=m?t.getBBox()[l?"width":"height"]:t[u],ue(d?s/g*h:s/100*g);if(o[l?"width":"height"]=h+(f?a:i),_=i!=="rem"&&~e.indexOf("adius")||i==="em"&&t.appendChild&&!c?t:t.parentNode,m&&(_=(t.ownerSVGElement||{}).parentNode),(!_||_===Qn||!_.appendChild)&&(_=Qn.body),p=_._gsap,p&&d&&p.width&&l&&p.time===$e.time&&!p.uncache)return ue(s/p.width*h);if(d&&(e==="height"||e==="width")){var S=t.style[e];t.style[e]=h+i,g=t[u],S?t.style[e]=S:ci(t,e)}else(d||a==="%")&&!Nv[Je(_,"display")]&&(o.position=Je(t,"position")),_===t&&(o.position="static"),_.appendChild(Ci),g=Ci[u],_.removeChild(Ci),o.position="absolute";return l&&d&&(p=Pi(_),p.time=$e.time,p.width=_[u]),ue(f?g*s/h:g&&s?h/g*s:0)},Nn=function(t,e,n,i){var s;return Ko||yo(),e in En&&e!=="transform"&&(e=En[e],~e.indexOf(",")&&(e=e.split(",")[0])),kn[e]&&e!=="transform"?(s=Kr(t,i),s=e!=="transformOrigin"?s[e]:s.svg?s.origin:Ks(Je(t,Ge))+" "+s.zOrigin+"px"):(s=t.style[e],(!s||s==="auto"||i||~(s+"").indexOf("calc("))&&(s=js[e]&&js[e](t,e,n)||Je(t,e)||Vu(t,e)||(e==="opacity"?1:0))),n&&!~(s+"").trim().indexOf(" ")?ui(t,e,s,n)+n:s},Ov=function(t,e,n,i){if(!n||n==="none"){var s=br(e,t,1),a=s&&Je(t,s,1);a&&a!==n?(e=s,n=a):e==="borderColor"&&(n=Je(t,"borderTopColor"))}var o=new He(this._pt,t.style,e,0,1,vh),l=0,c=0,u,h,f,d,g,_,p,m,S,x,E,w;if(o.b=n,o.e=i,n+="",i+="",i.substring(0,6)==="var(--"&&(i=Je(t,i.substring(4,i.indexOf(")")))),i==="auto"&&(_=t.style[e],t.style[e]=i,i=Je(t,e)||i,_?t.style[e]=_:ci(t,e)),u=[n,i],lh(u),n=u[0],i=u[1],f=n.match(ar)||[],w=i.match(ar)||[],w.length){for(;h=ar.exec(i);)p=h[0],S=i.substring(l,h.index),g?g=(g+1)%5:(S.substr(-5)==="rgba("||S.substr(-5)==="hsla(")&&(g=1),p!==(_=f[c++]||"")&&(d=parseFloat(_)||0,E=_.substr((d+"").length),p.charAt(1)==="="&&(p=hr(d,p)+E),m=parseFloat(p),x=p.substr((m+"").length),l=ar.lastIndex-x.length,x||(x=x||Qe.units[e]||E,l===i.length&&(i+=x,o.e+=x)),E!==x&&(d=ui(t,e,_,x)||0),o._pt={_next:o._pt,p:S||c===1?S:",",s:d,c:m-d,m:g&&g<4||e==="zIndex"?Math.round:0});o.c=l<i.length?i.substring(l,i.length):""}else o.r=e==="display"&&i==="none"?yh:Sh;return Bu.test(i)&&(o.e=0),this._pt=o,o},tu={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},Fv=function(t){var e=t.split(" "),n=e[0],i=e[1]||"50%";return(n==="top"||n==="bottom"||i==="left"||i==="right")&&(t=n,n=i,i=t),e[0]=tu[n]||n,e[1]=tu[i]||i,e.join(" ")},Bv=function(t,e){if(e.tween&&e.tween._time===e.tween._dur){var n=e.t,i=n.style,s=e.u,a=n._gsap,o,l,c;if(s==="all"||s===!0)i.cssText="",l=1;else for(s=s.split(","),c=s.length;--c>-1;)o=s[c],kn[o]&&(l=1,o=o==="transformOrigin"?Ge:ie),ci(n,o);l&&(ci(n,ie),a&&(a.svg&&n.removeAttribute("transform"),i.scale=i.rotate=i.translate="none",Kr(n,1),a.uncache=1,Eh(i)))}},js={clearProps:function(t,e,n,i,s){if(s.data!=="isFromStart"){var a=t._pt=new He(t._pt,e,n,0,0,Bv);return a.u=i,a.pr=-10,a.tween=s,t._props.push(n),1}}},jr=[1,0,0,1,0,0],Rh={},Ch=function(t){return t==="matrix(1, 0, 0, 1, 0, 0)"||t==="none"||!t},eu=function(t){var e=Je(t,ie);return Ch(e)?jr:e.substr(7).match(Fu).map(ue)},Jo=function(t,e){var n=t._gsap||Pi(t),i=t.style,s=eu(t),a,o,l,c;return n.svg&&t.getAttribute("transform")?(l=t.transform.baseVal.consolidate().matrix,s=[l.a,l.b,l.c,l.d,l.e,l.f],s.join(",")==="1,0,0,1,0,0"?jr:s):(s===jr&&!t.offsetParent&&t!==fr&&!n.svg&&(l=i.display,i.display="block",a=t.parentNode,(!a||!t.offsetParent&&!t.getBoundingClientRect().width)&&(c=1,o=t.nextElementSibling,fr.appendChild(t)),s=eu(t),l?i.display=l:ci(t,"display"),c&&(o?a.insertBefore(t,o):a?a.appendChild(t):fr.removeChild(t))),e&&s.length>6?[s[0],s[1],s[4],s[5],s[12],s[13]]:s)},Eo=function(t,e,n,i,s,a){var o=t._gsap,l=s||Jo(t,!0),c=o.xOrigin||0,u=o.yOrigin||0,h=o.xOffset||0,f=o.yOffset||0,d=l[0],g=l[1],_=l[2],p=l[3],m=l[4],S=l[5],x=e.split(" "),E=parseFloat(x[0])||0,w=parseFloat(x[1])||0,b,T,P,y;n?l!==jr&&(T=d*p-g*_)&&(P=E*(p/T)+w*(-_/T)+(_*S-p*m)/T,y=E*(-g/T)+w*(d/T)-(d*S-g*m)/T,E=P,w=y):(b=Ah(t),E=b.x+(~x[0].indexOf("%")?E/100*b.width:E),w=b.y+(~(x[1]||x[0]).indexOf("%")?w/100*b.height:w)),i||i!==!1&&o.smooth?(m=E-c,S=w-u,o.xOffset=h+(m*d+S*_)-m,o.yOffset=f+(m*g+S*p)-S):o.xOffset=o.yOffset=0,o.xOrigin=E,o.yOrigin=w,o.smooth=!!i,o.origin=e,o.originIsAbsolute=!!n,t.style[Ge]="0px 0px",a&&(ti(a,o,"xOrigin",c,E),ti(a,o,"yOrigin",u,w),ti(a,o,"xOffset",h,o.xOffset),ti(a,o,"yOffset",f,o.yOffset)),t.setAttribute("data-svg-origin",E+" "+w)},Kr=function(t,e){var n=t._gsap||new fh(t);if("x"in n&&!e&&!n.uncache)return n;var i=t.style,s=n.scaleX<0,a="px",o="deg",l=getComputedStyle(t),c=Je(t,Ge)||"0",u,h,f,d,g,_,p,m,S,x,E,w,b,T,P,y,M,C,D,I,N,k,O,G,z,et,nt,lt,Mt,Dt,K,Z;return u=h=f=_=p=m=S=x=E=0,d=g=1,n.svg=!!(t.getCTM&&wh(t)),l.translate&&((l.translate!=="none"||l.scale!=="none"||l.rotate!=="none")&&(i[ie]=(l.translate!=="none"?"translate3d("+(l.translate+" 0 0").split(" ").slice(0,3).join(", ")+") ":"")+(l.rotate!=="none"?"rotate("+l.rotate+") ":"")+(l.scale!=="none"?"scale("+l.scale.split(" ").join(",")+") ":"")+(l[ie]!=="none"?l[ie]:"")),i.scale=i.rotate=i.translate="none"),T=Jo(t,n.svg),n.svg&&(n.uncache?(z=t.getBBox(),c=n.xOrigin-z.x+"px "+(n.yOrigin-z.y)+"px",G=""):G=!e&&t.getAttribute("data-svg-origin"),Eo(t,G||c,!!G||n.originIsAbsolute,n.smooth!==!1,T)),w=n.xOrigin||0,b=n.yOrigin||0,T!==jr&&(C=T[0],D=T[1],I=T[2],N=T[3],u=k=T[4],h=O=T[5],T.length===6?(d=Math.sqrt(C*C+D*D),g=Math.sqrt(N*N+I*I),_=C||D?rr(D,C)*bi:0,S=I||N?rr(I,N)*bi+_:0,S&&(g*=Math.abs(Math.cos(S*dr))),n.svg&&(u-=w-(w*C+b*I),h-=b-(w*D+b*N))):(Z=T[6],Dt=T[7],nt=T[8],lt=T[9],Mt=T[10],K=T[11],u=T[12],h=T[13],f=T[14],P=rr(Z,Mt),p=P*bi,P&&(y=Math.cos(-P),M=Math.sin(-P),G=k*y+nt*M,z=O*y+lt*M,et=Z*y+Mt*M,nt=k*-M+nt*y,lt=O*-M+lt*y,Mt=Z*-M+Mt*y,K=Dt*-M+K*y,k=G,O=z,Z=et),P=rr(-I,Mt),m=P*bi,P&&(y=Math.cos(-P),M=Math.sin(-P),G=C*y-nt*M,z=D*y-lt*M,et=I*y-Mt*M,K=N*M+K*y,C=G,D=z,I=et),P=rr(D,C),_=P*bi,P&&(y=Math.cos(P),M=Math.sin(P),G=C*y+D*M,z=k*y+O*M,D=D*y-C*M,O=O*y-k*M,C=G,k=z),p&&Math.abs(p)+Math.abs(_)>359.9&&(p=_=0,m=180-m),d=ue(Math.sqrt(C*C+D*D+I*I)),g=ue(Math.sqrt(O*O+Z*Z)),P=rr(k,O),S=Math.abs(P)>2e-4?P*bi:0,E=K?1/(K<0?-K:K):0),n.svg&&(G=t.getAttribute("transform"),n.forceCSS=t.setAttribute("transform","")||!Ch(Je(t,ie)),G&&t.setAttribute("transform",G))),Math.abs(S)>90&&Math.abs(S)<270&&(s?(d*=-1,S+=_<=0?180:-180,_+=_<=0?180:-180):(g*=-1,S+=S<=0?180:-180)),e=e||n.uncache,n.x=u-((n.xPercent=u&&(!e&&n.xPercent||(Math.round(t.offsetWidth/2)===Math.round(-u)?-50:0)))?t.offsetWidth*n.xPercent/100:0)+a,n.y=h-((n.yPercent=h&&(!e&&n.yPercent||(Math.round(t.offsetHeight/2)===Math.round(-h)?-50:0)))?t.offsetHeight*n.yPercent/100:0)+a,n.z=f+a,n.scaleX=ue(d),n.scaleY=ue(g),n.rotation=ue(_)+o,n.rotationX=ue(p)+o,n.rotationY=ue(m)+o,n.skewX=S+o,n.skewY=x+o,n.transformPerspective=E+a,(n.zOrigin=parseFloat(c.split(" ")[2])||!e&&n.zOrigin||0)&&(i[Ge]=Ks(c)),n.xOffset=n.yOffset=0,n.force3D=Qe.force3D,n.renderTransform=n.svg?kv:bh?Ph:zv,n.uncache=0,n},Ks=function(t){return(t=t.split(" "))[0]+" "+t[1]},Ja=function(t,e,n){var i=Re(e);return ue(parseFloat(e)+parseFloat(ui(t,"x",n+"px",i)))+i},zv=function(t,e){e.z="0px",e.rotationY=e.rotationX="0deg",e.force3D=0,Ph(t,e)},yi="0deg",Ir="0px",Ei=") ",Ph=function(t,e){var n=e||this,i=n.xPercent,s=n.yPercent,a=n.x,o=n.y,l=n.z,c=n.rotation,u=n.rotationY,h=n.rotationX,f=n.skewX,d=n.skewY,g=n.scaleX,_=n.scaleY,p=n.transformPerspective,m=n.force3D,S=n.target,x=n.zOrigin,E="",w=m==="auto"&&t&&t!==1||m===!0;if(x&&(h!==yi||u!==yi)){var b=parseFloat(u)*dr,T=Math.sin(b),P=Math.cos(b),y;b=parseFloat(h)*dr,y=Math.cos(b),a=Ja(S,a,T*y*-x),o=Ja(S,o,-Math.sin(b)*-x),l=Ja(S,l,P*y*-x+x)}p!==Ir&&(E+="perspective("+p+Ei),(i||s)&&(E+="translate("+i+"%, "+s+"%) "),(w||a!==Ir||o!==Ir||l!==Ir)&&(E+=l!==Ir||w?"translate3d("+a+", "+o+", "+l+") ":"translate("+a+", "+o+Ei),c!==yi&&(E+="rotate("+c+Ei),u!==yi&&(E+="rotateY("+u+Ei),h!==yi&&(E+="rotateX("+h+Ei),(f!==yi||d!==yi)&&(E+="skew("+f+", "+d+Ei),(g!==1||_!==1)&&(E+="scale("+g+", "+_+Ei),S.style[ie]=E||"translate(0, 0)"},kv=function(t,e){var n=e||this,i=n.xPercent,s=n.yPercent,a=n.x,o=n.y,l=n.rotation,c=n.skewX,u=n.skewY,h=n.scaleX,f=n.scaleY,d=n.target,g=n.xOrigin,_=n.yOrigin,p=n.xOffset,m=n.yOffset,S=n.forceCSS,x=parseFloat(a),E=parseFloat(o),w,b,T,P,y;l=parseFloat(l),c=parseFloat(c),u=parseFloat(u),u&&(u=parseFloat(u),c+=u,l+=u),l||c?(l*=dr,c*=dr,w=Math.cos(l)*h,b=Math.sin(l)*h,T=Math.sin(l-c)*-f,P=Math.cos(l-c)*f,c&&(u*=dr,y=Math.tan(c-u),y=Math.sqrt(1+y*y),T*=y,P*=y,u&&(y=Math.tan(u),y=Math.sqrt(1+y*y),w*=y,b*=y)),w=ue(w),b=ue(b),T=ue(T),P=ue(P)):(w=h,P=f,b=T=0),(x&&!~(a+"").indexOf("px")||E&&!~(o+"").indexOf("px"))&&(x=ui(d,"x",a,"px"),E=ui(d,"y",o,"px")),(g||_||p||m)&&(x=ue(x+g-(g*w+_*T)+p),E=ue(E+_-(g*b+_*P)+m)),(i||s)&&(y=d.getBBox(),x=ue(x+i/100*y.width),E=ue(E+s/100*y.height)),y="matrix("+w+","+b+","+T+","+P+","+x+","+E+")",d.setAttribute("transform",y),S&&(d.style[ie]=y)},Hv=function(t,e,n,i,s){var a=360,o=Ee(s),l=parseFloat(s)*(o&&~s.indexOf("rad")?bi:1),c=l-i,u=i+c+"deg",h,f;return o&&(h=s.split("_")[1],h==="short"&&(c%=a,c!==c%(a/2)&&(c+=c<0?a:-a)),h==="cw"&&c<0?c=(c+a*Kc)%a-~~(c/a)*a:h==="ccw"&&c>0&&(c=(c-a*Kc)%a-~~(c/a)*a)),t._pt=f=new He(t._pt,e,n,i,c,Ev),f.e=u,f.u="deg",t._props.push(n),f},nu=function(t,e){for(var n in e)t[n]=e[n];return t},Gv=function(t,e,n){var i=nu({},n._gsap),s="perspective,force3D,transformOrigin,svgOrigin",a=n.style,o,l,c,u,h,f,d,g;i.svg?(c=n.getAttribute("transform"),n.setAttribute("transform",""),a[ie]=e,o=Kr(n,1),ci(n,ie),n.setAttribute("transform",c)):(c=getComputedStyle(n)[ie],a[ie]=e,o=Kr(n,1),a[ie]=c);for(l in kn)c=i[l],u=o[l],c!==u&&s.indexOf(l)<0&&(d=Re(c),g=Re(u),h=d!==g?ui(n,l,c,g):parseFloat(c),f=parseFloat(u),t._pt=new He(t._pt,o,l,h,f-h,Mo),t._pt.u=g||0,t._props.push(l));nu(o,i)};ke("padding,margin,Width,Radius",function(r,t){var e="Top",n="Right",i="Bottom",s="Left",a=(t<3?[e,n,i,s]:[e+s,e+n,i+n,i+s]).map(function(o){return t<2?r+o:"border"+o+r});js[t>1?"border"+r:r]=function(o,l,c,u,h){var f,d;if(arguments.length<4)return f=a.map(function(g){return Nn(o,g,c)}),d=f.join(" "),d.split(f[0]).length===5?f[0]:d;f=(u+"").split(" "),d={},a.forEach(function(g,_){return d[g]=f[_]=f[_]||f[(_-1)/2|0]}),o.init(l,d,h)}});var Lh={name:"css",register:yo,targetTest:function(t){return t.style&&t.nodeType},init:function(t,e,n,i,s){var a=this._props,o=t.style,l=n.vars.startAt,c,u,h,f,d,g,_,p,m,S,x,E,w,b,T,P,y;Ko||yo(),this.styles=this.styles||Th(t),P=this.styles.props,this.tween=n;for(_ in e)if(_!=="autoRound"&&(u=e[_],!(Ke[_]&&dh(_,e,n,i,t,s)))){if(d=typeof u,g=js[_],d==="function"&&(u=u.call(n,i,t,s),d=typeof u),d==="string"&&~u.indexOf("random(")&&(u=Xr(u)),g)g(this,t,_,u,n)&&(T=1);else if(_.substr(0,2)==="--")c=(getComputedStyle(t).getPropertyValue(_)+"").trim(),u+="",ri.lastIndex=0,ri.test(c)||(p=Re(c),m=Re(u),m?p!==m&&(c=ui(t,_,c,m)+m):p&&(u+=p)),this.add(o,"setProperty",c,u,i,s,0,0,_),a.push(_),P.push(_,0,o[_]);else if(d!=="undefined"){if(l&&_ in l?(c=typeof l[_]=="function"?l[_].call(n,i,t,s):l[_],Ee(c)&&~c.indexOf("random(")&&(c=Xr(c)),Re(c+"")||c==="auto"||(c+=Qe.units[_]||Re(Nn(t,_))||""),(c+"").charAt(1)==="="&&(c=Nn(t,_))):c=Nn(t,_),f=parseFloat(c),S=d==="string"&&u.charAt(1)==="="&&u.substr(0,2),S&&(u=u.substr(2)),h=parseFloat(u),_ in En&&(_==="autoAlpha"&&(f===1&&Nn(t,"visibility")==="hidden"&&h&&(f=0),P.push("visibility",0,o.visibility),ti(this,o,"visibility",f?"inherit":"hidden",h?"inherit":"hidden",!h)),_!=="scale"&&_!=="transform"&&(_=En[_],~_.indexOf(",")&&(_=_.split(",")[0]))),x=_ in kn,x){if(this.styles.save(_),y=u,d==="string"&&u.substring(0,6)==="var(--"){if(u=Je(t,u.substring(4,u.indexOf(")"))),u.substring(0,5)==="calc("){var M=t.style.perspective;t.style.perspective=u,u=Je(t,"perspective"),M?t.style.perspective=M:ci(t,"perspective")}h=parseFloat(u)}if(E||(w=t._gsap,w.renderTransform&&!e.parseTransform||Kr(t,e.parseTransform),b=e.smoothOrigin!==!1&&w.smooth,E=this._pt=new He(this._pt,o,ie,0,1,w.renderTransform,w,0,-1),E.dep=1),_==="scale")this._pt=new He(this._pt,w,"scaleY",w.scaleY,(S?hr(w.scaleY,S+h):h)-w.scaleY||0,Mo),this._pt.u=0,a.push("scaleY",_),_+="X";else if(_==="transformOrigin"){P.push(Ge,0,o[Ge]),u=Fv(u),w.svg?Eo(t,u,0,b,0,this):(m=parseFloat(u.split(" ")[2])||0,m!==w.zOrigin&&ti(this,w,"zOrigin",w.zOrigin,m),ti(this,o,_,Ks(c),Ks(u)));continue}else if(_==="svgOrigin"){Eo(t,u,1,b,0,this);continue}else if(_ in Rh){Hv(this,w,_,f,S?hr(f,S+u):u);continue}else if(_==="smoothOrigin"){ti(this,w,"smooth",w.smooth,u);continue}else if(_==="force3D"){w[_]=u;continue}else if(_==="transform"){Gv(this,u,t);continue}}else _ in o||(_=br(_)||_);if(x||(h||h===0)&&(f||f===0)&&!yv.test(u)&&_ in o)p=(c+"").substr((f+"").length),h||(h=0),m=Re(u)||(_ in Qe.units?Qe.units[_]:p),p!==m&&(f=ui(t,_,c,m)),this._pt=new He(this._pt,x?w:o,_,f,(S?hr(f,S+h):h)-f,!x&&(m==="px"||_==="zIndex")&&e.autoRound!==!1?Av:Mo),this._pt.u=m||0,x&&y!==u?(this._pt.b=c,this._pt.e=y,this._pt.r=bv):p!==m&&m!=="%"&&(this._pt.b=c,this._pt.r=Tv);else if(_ in o)Ov.call(this,t,_,c,S?S+u:u);else if(_ in t)this.add(t,_,c||t[_],S?S+u:u,i,s);else if(_!=="parseTransform"){zo(_,u);continue}x||(_ in o?P.push(_,0,o[_]):typeof t[_]=="function"?P.push(_,2,t[_]()):P.push(_,1,c||t[_])),a.push(_)}}T&&xh(this)},render:function(t,e){if(e.tween._time||!$o())for(var n=e._pt;n;)n.r(t,n.d),n=n._next;else e.styles.revert()},get:Nn,aliases:En,getSetter:function(t,e,n){var i=En[e];return i&&i.indexOf(",")<0&&(e=i),e in kn&&e!==Ge&&(t._gsap.x||Nn(t,"x"))?n&&jc===n?e==="scale"?Pv:Cv:(jc=n||{})&&(e==="scale"?Lv:Dv):t.style&&!Oo(t.style[e])?wv:~e.indexOf("-")?Rv:qo(t,e)},core:{_removeProperty:ci,_getMatrix:Jo}};Ve.utils.checkPrefix=br;Ve.core.getStyleSaver=Th;(function(r,t,e,n){var i=ke(r+","+t+","+e,function(s){kn[s]=1});ke(t,function(s){Qe.units[s]="deg",Rh[s]=1}),En[i[13]]=r+","+t,ke(n,function(s){var a=s.split(":");En[a[1]]=i[a[0]]})})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent","rotation,rotationX,rotationY,skewX,skewY","transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective","0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");ke("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",function(r){Qe.units[r]="px"});Ve.registerPlugin(Lh);var Oe=Ve.registerPlugin(Lh)||Ve;Oe.core.Tween;function Vv({camera:r,controls:t,globeGroup:e,interaction:n,globeRadius:i}){const s=new F,a=new F,o=new F,l=new re,c=new F,u=new F;let h=null,f=null;function d(){h&&(h.kill(),h=null),Oe.killTweensOf(r.position),Oe.killTweensOf(t.target)}function g(){const E=e.scale.x||1;return i*E}function _(E=s){return E.copy(e.position),E}function p(E){const w=Number.isFinite(t.minDistance)?t.minDistance:0,b=Number.isFinite(t.maxDistance)?t.maxDistance:1/0,T=.001;let P=E;return w>0&&(P=Math.max(P,w+T)),Number.isFinite(b)&&(P=Math.min(P,b-T)),P}function m({markerMesh:E,layout:w}){const b=g(),T=_(new F);E.getWorldPosition(a),o.copy(a).sub(T).normalize();const P=p(b*2.15),y=a.clone().add(o.clone().multiplyScalar(P));l.lookAt(y,a,r.up),c.setFromMatrixColumn(l,0).normalize(),u.setFromMatrixColumn(l,1).normalize();const M=b*.42,C=b*.22,D=(w==null?void 0:w.globeCorner)||((w==null?void 0:w.cardSide)==="right"?"TL":"BR");let I=0,N=0;D==="TL"?(I=1,N=-1):D==="BR"?(I=-1,N=1):D==="TR"?(I=-1,N=-1):D==="BL"&&(I=1,N=1);const k=a.clone().add(c.clone().multiplyScalar(M*I)).add(u.clone().multiplyScalar(C*N));return{endPos:y,endTarget:k}}function S({id:E,markerMesh:w,layout:b}){var C;if(!w)return;n.focusActive||(f={camPos:r.position.clone(),target:t.target.clone()}),n.focusActive=!0,n.focusId=E,(C=n.bumpIdle)==null||C.call(n,1200),d();const{endPos:T,endTarget:P}=m({markerMesh:w,layout:b}),y=t.enabled,M=t.enableDamping;t.enabled=!1,t.enableDamping=!1,h=Oe.timeline({defaults:{ease:"power3.out"},onUpdate:()=>{t.update()},onComplete:()=>{r.position.copy(T),t.target.copy(P),t.update(),t.enableDamping=M,t.enabled=y,h=null}}),h.to(r.position,{x:T.x,y:T.y,z:T.z,duration:1.05},0),h.to(t.target,{x:P.x,y:P.y,z:P.z,duration:1.05},0)}function x(){var P;if(!n.focusActive)return;if(n.focusActive=!1,n.focusId=null,(P=n.bumpIdle)==null||P.call(n,900),!f){d();return}d();const E=f.camPos.clone(),w=f.target.clone();f=null;const b=t.enabled,T=t.enableDamping;t.enabled=!1,t.enableDamping=!1,h=Oe.timeline({defaults:{ease:"power3.out"},onUpdate:()=>{t.update()},onComplete:()=>{r.position.copy(E),t.target.copy(w),t.update(),t.enableDamping=T,t.enabled=b,h=null}}),h.to(r.position,{x:E.x,y:E.y,z:E.z,duration:.85},0),h.to(t.target,{x:w.x,y:w.y,z:w.z,duration:.85},0)}return{focus:S,clear:x}}function Ur(r){return String(r).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Wv({items:r,viewport:t,avoid:e}){const i=Number.isFinite(e==null?void 0:e.padding)?e.padding:22,s=e==null?void 0:e.globeCircle,a=(e==null?void 0:e.safeInsets)||{},o=a.left??16,l=a.right??16,c=a.top??14,u=a.bottom??14,h=.5,f=90,d=70,g=900;function _(C,D,I){return Math.max(D,Math.min(I,C))}function p(C,D,I,N,k,O,G){const z=I-C,et=N-D,nt=k-C,lt=O-D,Mt=z*z+et*et;if(Mt<1e-6)return Math.hypot(nt,lt)<=G;let Dt=(nt*z+lt*et)/Mt;Dt=Math.max(0,Math.min(1,Dt));const K=C+Dt*z,Z=D+Dt*et;return Math.hypot(K-k,Z-O)<=G}function m(C,D){const I=o,N=t.width-l-D;if(!s||!Number.isFinite(s.cx)||!Number.isFinite(s.r)){const z=(o+(t.width-l))*.5;return C==="left"?{min:I,max:Math.min(N,z-D),ok:I<=Math.min(N,z-D)}:{min:Math.max(I,z),max:N,ok:Math.max(I,z)<=N}}const k=s.cx-s.r-i,O=s.cx+s.r+i;if(C==="left"){const z=Math.min(N,k-D);return{min:I,max:z,ok:I<=z}}const G=Math.max(I,O);return{min:G,max:N,ok:G<=N}}function S(C,D){const I=m(C,D);return I.ok?{x:I.min+(I.max-I.min)*h,ok:!0}:{x:_(C==="left"?o:t.width-l-D,o,t.width-l-D),ok:!1}}function x(C,D,I,N){const k=C.anchorScreen.x,O=C.anchorScreen.y,G=C.w||360,z=D==="right"?I+2:I+G-2,et=O;let nt=Math.hypot(z-k,et-O);if(s&&Number.isFinite(s.cx)&&Number.isFinite(s.r)){const lt=s.r+i*.85;p(k,O,z,et,s.cx,s.cy,lt)&&(nt+=g)}return C.prevSide&&C.prevSide!==D&&(nt+=f),nt+=(N[D]||0)*d,C.hintSide&&C.hintSide!==D&&(nt+=18),nt}const E=[...r].sort((C,D)=>C.anchorScreen.y-D.anchorScreen.y),w=[],b=[],T={left:0,right:0};for(const C of E){const D=C.w||360;if(C.lockSide==="left"||C.lockSide==="right"){const G=C.lockSide;(G==="left"?w:b).push({...C,side:G}),T[G]+=1;continue}const I=S("left",D),N=S("right",D);if(I.ok&&!N.ok){w.push({...C,side:"left"}),T.left+=1;continue}if(!I.ok&&N.ok){b.push({...C,side:"right"}),T.right+=1;continue}const k=x(C,"left",I.x,T),O=x(C,"right",N.x,T);k<=O?(w.push({...C,side:"left"}),T.left+=1):(b.push({...C,side:"right"}),T.right+=1)}function P(C){const D=[],I=t.height-u;let N=c;for(const k of C){const O=k.w||360,G=k.h||180,{x:z}=S(k.side,O);let et=_(k.anchorScreen.y-G*.5,c,I-G);et=Math.max(et,N),D.push({id:k.id,x:Math.round(_(z,o,t.width-l-O)),y:Math.round(et),side:k.side,anchorScreen:k.anchorScreen,alpha:k.alpha}),N=et+G+12}if(D.length){const k=D[D.length-1],O=C[C.length-1].h||180,G=k.y+O-I;if(G>0){for(const z of D)z.y=Math.round(z.y-G);if(D[0].y<c){D[0].y=c;for(let z=1;z<D.length;z++){const et=D[z-1],nt=C[z-1].h||180;D[z].y=Math.max(D[z].y,et.y+nt+12)}}}}return D}const y=P(w),M=P(b);return[...y,...M]}function Xv({hud:r,onSelect:t,onOpen:e}){const n=document.createElement("div");n.className="atlas-cards",r.appendChild(n);const i=new Map;function s(h){const f=h.getBoundingClientRect();return{w:f.width||360,h:f.height||180}}function a(h,f){const d=document.createElement("div");d.className="atlas-card",d.dataset.id=String(f),d.innerHTML=`
    ...
    `,d.addEventListener("click",p=>{p.preventDefault(),p.stopPropagation(),t==null||t({id:f}),e==null||e(h)}),d.style.visibility="hidden",n.appendChild(d);const{w:g,h:_}=s(d);return Oe.set(d,{x:-9999,y:-9999,opacity:0,scale:.98}),{el:d,w:g,h:_,isNew:!0,linkReady:!1,side:null,alpha:1}}function o(h){const f=i.get(h);f&&(i.delete(h),Oe.to(f.el,{opacity:0,scale:.98,duration:.18,ease:"power2.in",onComplete:()=>f.el.remove()}))}function l(h,f,d,g){const _=f>=d?"right":"left";return h.side?(h.side==="left"&&f>d+g&&(h.side="right"),h.side==="right"&&f<d-g&&(h.side="left"),h.side):(h.side=_,h.side)}function c(h,f){const d=i.get(h);if(!d||!d.el||!f)return null;const g=d.el.getBoundingClientRect();return!g.width||!g.height?null:{id:h,side:d.side,rectLocal:{left:g.left-f.left,top:g.top-f.top,width:g.width,height:g.height}}}function u({visibleItems:h,viewport:f,stageRect:d,focus:g}){const _=new Set(h.map(w=>w.id));for(const w of i.keys())_.has(w)||o(w);for(const w of h)i.has(w.id)||i.set(w.id,a(w.breach,w.id));const p=f.width*.5,m=Math.min(110,Math.max(70,f.width*.06)),S=h.map(w=>{const b=i.get(w.id),P=!!(g!=null&&g.active&&(g==null?void 0:g.id)===w.id)?(g==null?void 0:g.cardSide)||w.preferredSide||b.side||"right":l(b,w.anchorScreen.x,p,m);return b.side=P,b.alpha=w.alpha,{id:w.id,anchorScreen:w.anchorScreen,preferredSide:P,w:(b==null?void 0:b.w)??360,h:(b==null?void 0:b.h)??180,alpha:w.alpha}}),x=Wv({items:S,viewport:f}),E=[];for(const w of x){const b=i.get(w.id);if(!b)continue;const T=!!(g!=null&&g.active&&(g==null?void 0:g.id)===w.id);b.el.classList.toggle("atlas-card--focused",T),T&&(g!=null&&g.pin)&&Number.isFinite(g.pin.x)&&Number.isFinite(g.pin.y)&&(w.x=g.pin.x,w.y=g.pin.y,w.preferredSide=g.pin.side||w.preferredSide),b.side=w.preferredSide;const P=T?1.04:1;if(b.isNew)b.el.style.visibility="visible",Oe.set(b.el,{x:w.x,y:w.y}),Oe.to(b.el,{opacity:b.alpha,scale:P,duration:.22,ease:"power2.out"}),b.isNew=!1,b.linkReady=!1,requestAnimationFrame(()=>{b.linkReady=!0});else{const Dt=Number(Oe.getProperty(b.el,"x"))||0,K=Number(Oe.getProperty(b.el,"y"))||0,ft=Math.hypot(Dt-w.x,K-w.y)>500?.45:.26;Oe.to(b.el,{x:w.x,y:w.y,duration:ft,ease:"power2.out",overwrite:!0}),Oe.to(b.el,{opacity:b.alpha,duration:.18,ease:"power2.out",overwrite:"auto"}),Oe.to(b.el,{scale:P,duration:.22,ease:"power2.out",overwrite:"auto"})}const y=b.el.getBoundingClientRect(),M=y.top-d.top+y.height*.5,C=2,D=y.left-d.left+C,I=y.left-d.left+y.width-C,N=w.anchorScreen.x,k=w.anchorScreen.y,O=N-D,G=k-M,z=O*O+G*G,et=N-I,nt=k-M,lt=et*et+nt*nt,Mt=z<=lt?D:I;b.linkReady&&E.push({id:w.id,anchorScreen:w.anchorScreen,backScreen:{x:Mt,y:M},alpha:b.alpha})}return E}return{update:u,getCardLayout:c}}function Yv({hud:r}){const t=document.createElement("canvas");t.className="atlas-links",r.appendChild(t);const e=t.getContext("2d",{alpha:!0});let n=0,i=0,s=0;function a(f){const d=Math.min(window.devicePixelRatio||1,2);f.width!==n||f.height!==i||d!==s?(n=f.width,i=f.height,s=d,t.style.width=`${f.width}px`,t.style.height=`${f.height}px`,t.width=Math.round(f.width*d),t.height=Math.round(f.height*d),e.setTransform(d,0,0,d,0,0),e.lineCap="round",e.lineJoin="round"):e.setTransform(s,0,0,s,0,0)}function o(f){let d=2166136261;for(let g=0;g<f.length;g++)d^=f.charCodeAt(g),d=Math.imul(d,16777619);return(d>>>0)%1e4/1e4}function l(f,d,g,_,p,m,S){const x=1-S,E=x*x*f+2*x*S*g+S*S*p,w=x*x*d+2*x*S*_+S*S*m;return{x:E,y:w}}function c(f,d,g,_,p,m){e.beginPath(),e.moveTo(f,d),e.quadraticCurveTo(g,_,p,m),e.stroke()}function u(f,d,g,_,p,m,S,x){e.beginPath();for(let w=0;w<=18;w++){const b=S+(x-S)*w/18,T=l(f,d,g,_,p,m,b);w===0?e.moveTo(T.x,T.y):e.lineTo(T.x,T.y)}e.stroke()}function h({connections:f,viewport:d,time:g}){a(d),e.clearRect(0,0,d.width,d.height);for(const _ of f){const p=_.from.x,m=_.from.y,S=_.to.x,x=_.to.y,E=Math.max(0,Math.min(1,_.alpha??1)),w=(p+S)*.5,b=(m+x)*.5,T=S-p,P=x-m,y=Math.max(1,Math.hypot(T,P)),M=-P/y,C=T/y,D=Math.min(140,y*.22),I=w+M*D,N=b+C*D;e.setLineDash([]),e.lineWidth=1.2,e.globalAlpha=.55*E,e.strokeStyle="rgba(245,245,245,1)",c(p,m,I,N,S,x),e.setLineDash([10,14]),e.lineDashOffset=-(g*38+o(_.id)*60),e.lineWidth=1,e.globalAlpha=.18*E,e.strokeStyle="rgba(245,245,245,1)",c(p,m,I,N,S,x);const k=(g*.22+o(_.id))%1,O=.16;let G=k-O*.5,z=k+O*.5;G<0?(e.setLineDash([]),e.lineWidth=2.6,e.globalAlpha=.22*E,e.strokeStyle="rgba(245,245,245,1)",u(p,m,I,N,S,x,0,z),u(p,m,I,N,S,x,1+G,1),e.lineWidth=1.6,e.globalAlpha=.42*E,u(p,m,I,N,S,x,0,z),u(p,m,I,N,S,x,1+G,1)):z>1?(e.setLineDash([]),e.lineWidth=2.6,e.globalAlpha=.22*E,e.strokeStyle="rgba(245,245,245,1)",u(p,m,I,N,S,x,G,1),u(p,m,I,N,S,x,0,z-1),e.lineWidth=1.6,e.globalAlpha=.42*E,u(p,m,I,N,S,x,G,1),u(p,m,I,N,S,x,0,z-1)):(e.setLineDash([]),e.lineWidth=2.6,e.globalAlpha=.22*E,e.strokeStyle="rgba(245,245,245,1)",u(p,m,I,N,S,x,G,z),e.lineWidth=1.6,e.globalAlpha=.42*E,u(p,m,I,N,S,x,G,z)),e.globalAlpha=1,e.setLineDash([])}}return{update:h}}const qv="https://api.github.com/orgs/TITAN-Softwork-Solutions/repos?per_page=8&sort=updated";function jv(){const r=document.querySelector('[data-menu="projects"] .site-nav__dropdown');if(!r)return;const t=[...r.querySelectorAll("a[data-repo]")],e=new Set(t.map(s=>{var a;return(a=s.dataset.repo)==null?void 0:a.toLowerCase()}).filter(Boolean)),i=Math.max(0,8-e.size);i&&fetch(qv).then(s=>s.ok?s.json():Promise.reject(new Error("GitHub API error"))).then(s=>{let a=0;for(const o of s){if(!o||!o.name||o.archived)continue;const l=o.name.toLowerCase();if(e.has(l))continue;const c=document.createElement("a");if(c.textContent=o.name,c.href=o.html_url,c.target="_blank",c.rel="noreferrer",r.appendChild(c),e.add(l),a+=1,a>=i)break}}).catch(()=>{})}function Kv(){const r=document.querySelector("[data-discord-widget]");if(!r)return;const t=r.dataset.invite,e=r.querySelector("[data-discord-online]"),n=r.querySelector("[data-discord-members]"),i=r.querySelector(".communityWidget__note"),s=r.querySelector("[data-discord-link]");if(!t||!e||!n)return;const a=`https://discord.com/api/v10/invites/${t}?with_counts=true&with_expiration=false`;function o(){e.textContent="--",n.textContent="--",i&&(i.textContent="Loading Discord counts...")}function l(){e.textContent="--",n.textContent="--",i&&(i.textContent="Counts unavailable. Open the hub.")}function c(h,f){e.textContent=String(h??"--"),n.textContent=String(f??"--"),i&&(i.textContent="Live member counts from Discord.")}async function u(){try{const h=await fetch(a,{cache:"no-store"});if(!h.ok)throw new Error(`Discord invite lookup failed: HTTP ${h.status}`);const f=await h.json(),d=f==null?void 0:f.approximate_presence_count,g=f==null?void 0:f.approximate_member_count;c(d,g),s&&(s.href=(f==null?void 0:f.invite_url)||`https://discord.gg/${t}`)}catch{l(),s&&(s.href="https://hub.titansoftwork.com")}}o(),u(),setInterval(u,6e4)}async function $v(){const{scene:r,camera:t,renderer:e,hud:n}=u0();h0({camera:t,renderer:e}),jv(),Kv();const i=document.querySelector(".hero"),s=document.getElementById("stage"),a=window.matchMedia("(max-width: 900px), (pointer: coarse)"),o=()=>a.matches,l=await d0(),c=_0({scene:r}),u=S0({globeGroup:c.group,breaches:l,radius:c.radius}),h=new Map(u.items.map(M=>[M.id,M])),f=T0({camera:t,renderer:e,interaction:we}),d=Vv({camera:t,controls:f.controls,globeGroup:c.group,interaction:we,globeRadius:c.radius}),g=Yv({hud:n});let _=!1;function p(){i&&(delete i.dataset.focus,delete i.dataset.cardSide)}function m(M){_=!!(M&&!o()),i==null||i.classList.toggle("hero--focus",_),i==null||i.classList.toggle("hero--bg",!_),document.body.classList.toggle("globe-foreground",_),f.controls.enabled=_,_||(we.focusActive&&d.clear(),p())}i&&(i.classList.add("hero--bg"),i.classList.remove("hero--focus")),m(!1);function S(){o()&&m(!1)}a.addEventListener?a.addEventListener("change",S):a.addListener(S);function x(M){_||M.stopImmediatePropagation()}function E(M){_||M.stopImmediatePropagation()}e.domElement.addEventListener("wheel",x,{capture:!0,passive:!0}),e.domElement.addEventListener("touchmove",E,{capture:!0,passive:!0});function w(M){_&&M.preventDefault()}function b(M){_&&M.preventDefault()}s.addEventListener("wheel",w,{passive:!1,capture:!0}),s.addEventListener("touchmove",b,{passive:!1,capture:!0}),s.addEventListener("pointerdown",M=>{var C,D;o()||(D=(C=M.target)==null?void 0:C.closest)!=null&&D.call(C,".atlas-card")||_||(m(!0),M.preventDefault(),M.stopPropagation())},{capture:!0}),window.addEventListener("keydown",M=>{M.key==="Escape"&&_&&m(!1)});let T={globeCorner:"TL",cardSide:"right"},P=null;const y=Xv({hud:n,onSelect:({id:M})=>{var G;if(o()||!_)return;if(we.focusActive&&we.focusId===M){P=null,d.clear();return}const C=h.get(M);if(!C)return;const D=e.domElement.getBoundingClientRect(),I=e.domElement.clientWidth,N=(G=y.getCardLayout)==null?void 0:G.call(y,M,D);let k=N==null?void 0:N.side;k||(k=((C.anchor||C.mesh).getWorldPosition(new F).clone().project(t).x*.5+.5)*I>=I*.5?"right":"left"),T={globeCorner:k==="right"?"TL":"BR",cardSide:k},N!=null&&N.rectLocal?P={id:M,x:N.rectLocal.left,y:N.rectLocal.top,side:k}:P={id:M,x:null,y:null,side:k},i&&(i.dataset.cardSide=k,i.dataset.focus="1"),d.focus({id:M,markerMesh:C.mesh,layout:T})}});s.addEventListener("pointerdown",M=>{var C,D;o()||(D=(C=M.target)==null?void 0:C.closest)!=null&&D.call(C,".atlas-card")||_&&we.focusActive&&(P=null,d.clear())}),we.bumpIdle(800),f0({scene:r,camera:t,renderer:e,orbitControls:f.controls,interaction:we,globeGroup:c.group,onFrame:({time:M,width:C,height:D})=>{const I=e.domElement.getBoundingClientRect();for(const O of u.items)O.spinOuter&&(O.spinOuter.rotation.y=M*O.spinSpeedOuter),O.spinInner&&(O.spinInner.rotation.y=-M*O.spinSpeedInner);i&&(we.focusActive&&we.focusId?(i.dataset.focus="1",i.dataset.cardSide=T.cardSide):(delete i.dataset.focus,delete i.dataset.cardSide,P=null));let N;if(we.focusActive&&we.focusId){const O=h.get(we.focusId);if(!O)return;const z=O.mesh.getWorldPosition(new F).clone().project(t),et=(z.x*.5+.5)*C,nt=(-z.y*.5+.5)*D;N=[{id:O.id,breach:O.breach,anchorScreen:{x:et,y:nt},preferredSide:T.cardSide,alpha:1}]}else N=M0({markers:u.items,camera:t,globeCenterWorld:c.centerWorld,width:C,height:D}),_||(N=N.map(O=>({...O,alpha:(O.alpha??1)*.55})));const k=y.update({visibleItems:N,viewport:{width:C,height:D},stageRect:I,focus:{active:we.focusActive,id:we.focusId,globeCorner:T.globeCorner,cardSide:T.cardSide,pin:P&&P.id===we.focusId?{x:P.x,y:P.y,side:P.side}:null},time:M});g.update({viewport:{width:C,height:D},time:M,connections:k.map(O=>({id:O.id,from:O.anchorScreen,to:O.backScreen,alpha:O.alpha}))})}})}$v();
