...
`)+`
`+m);const v=S+p+a,E=S+m+o,w=dc(i,i.VERTEX_SHADER,v),T=dc(i,i.FRAGMENT_SHADER,E);i.attachShader(_,w),i.attachShader(_,T),e.index0AttributeName!==void 0?i.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function A(C){if(r.debug.checkShaderErrors){const I=i.getProgramInfoLog(_).trim(),D=i.getShaderInfoLog(w).trim(),U=i.getShaderInfoLog(T).trim();let k=!0,O=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(k=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,w,T);else{const X=pc(i,w,"vertex"),z=pc(i,T,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
}`;function Bg(r,t,e){let n=new Po;const i=new bt,s=new bt,a=new Se,o=new Ug({depthPacking:Df}),l=new Ng,c={},u=e.maxTextureSize,h={[si]:Be,[Be]:si,[On]:On},f=new oi({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new bt},radius:{value:4}},vertexShader:Og,fragmentShader:Fg}),d=f.clone();d.defines.HORIZONTAL_PASS=1;const g=new hn;g.setAttribute("position",new Tn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new Fe(g,f),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=iu;let m=this.type;this.render=function(T,A,P){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||T.length===0)return;const y=r.getRenderTarget(),M=r.getActiveCubeFace(),C=r.getActiveMipmapLevel(),I=r.state;I.setBlending(ei),I.buffers.color.setClear(1,1,1,1),I.buffers.depth.setTest(!0),I.setScissorTest(!1);const D=m!==In&&this.type===In,U=m===In&&this.type!==In;for(let k=0,O=T.length;k<O;k++){const X=T[k],z=X.shadow;if(z===void 0){console.warn("THREE.WebGLShadowMap:",X,"has no shadow.");continue}if(z.autoUpdate===!1&&z.needsUpdate===!1)continue;i.copy(z.mapSize);const et=z.getFrameExtents();if(i.multiply(et),s.copy(z.mapSize),(i.x>u||i.y>u)&&(i.x>u&&(s.x=Math.floor(u/et.x),i.x=s.x*et.x,z.mapSize.x=s.x),i.y>u&&(s.y=Math.floor(u/et.y),i.y=s.y*et.y,z.mapSize.y=s.y)),z.map===null||D===!0||U===!0){const lt=this.type!==In?{minFilter:ln,magFilter:ln}:{};z.map!==null&&z.map.dispose(),z.map=new Ui(i.x,i.y,lt),z.map.texture.name=X.name+".shadowMap",z.camera.updateProjectionMatrix()}r.setRenderTarget(z.map),r.clear();const nt=z.getViewportCount();for(let lt=0;lt<nt;lt++){const Mt=z.getViewport(lt);a.set(s.x*Mt.x,s.y*Mt.y,s.x*Mt.z,s.y*Mt.w),I.viewport(a),z.updateMatrices(X,lt),n=z.getFrustum(),E(A,P,z.camera,X,this.type)}z.isPointLightShadow!==!0&&this.type===In&&S(z,P),z.needsUpdate=!1}m=this.type,p.needsUpdate=!1,r.setRenderTarget(y,M,C)};function S(T,A){const P=t.update(_);f.defines.VSM_SAMPLES!==T.blurSamples&&(f.defines.VSM_SAMPLES=T.blurSamples,d.defines.VSM_SAMPLES=T.blurSamples,f.needsUpdate=!0,d.needsUpdate=!0),T.mapPass===null&&(T.mapPass=new Ui(i.x,i.y)),f.uniforms.shadow_pass.value=T.map.texture,f.uniforms.resolution.value=T.mapSize,f.uniforms.radius.value=T.radius,r.setRenderTarget(T.mapPass),r.clear(),r.renderBufferDirect(A,null,P,f,_,null),d.uniforms.shadow_pass.value=T.mapPass.texture,d.uniforms.resolution.value=T.mapSize,d.uniforms.radius.value=T.radius,r.setRenderTarget(T.map),r.clear(),r.renderBufferDirect(A,null,P,d,_,null)}function v(T,A,P,y){let M=null;const C=P.isPointLight===!0?T.customDistanceMaterial:T.customDepthMaterial;if(C!==void 0)M=C;else if(M=P.isPointLight===!0?l:o,r.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0){const I=M.uuid,D=A.uuid;let U=c[I];U===void 0&&(U={},c[I]=U);let k=U[D];k===void 0&&(k=M.clone(),U[D]=k,A.addEventListener("dispose",w)),M=k}if(M.visible=A.visible,M.wireframe=A.wireframe,y===In?M.side=A.shadowSide!==null?A.shadowSide:A.side:M.side=A.shadowSide!==null?A.shadowSide:h[A.side],M.alphaMap=A.alphaMap,M.alphaTest=A.alphaTest,M.map=A.map,M.clipShadows=A.clipShadows,M.clippingPlanes=A.clippingPlanes,M.clipIntersection=A.clipIntersection,M.displacementMap=A.displacementMap,M.displacementScale=A.displacementScale,M.displacementBias=A.displacementBias,M.wireframeLinewidth=A.wireframeLinewidth,M.linewidth=A.linewidth,P.isPointLight===!0&&M.isMeshDistanceMaterial===!0){const I=r.properties.get(M);I.light=P}return M}function E(T,A,P,y,M){if(T.visible===!1)return;if(T.layers.test(A.layers)&&(T.isMesh||T.isLine||T.isPoints)&&(T.castShadow||T.receiveShadow&&M===In)&&(!T.frustumCulled||n.intersectsObject(T))){T.modelViewMatrix.multiplyMatrices(P.matrixWorldInverse,T.matrixWorld);const D=t.update(T),U=T.material;if(Array.isArray(U)){const k=D.groups;for(let O=0,X=k.length;O<X;O++){const z=k[O],et=U[z.materialIndex];if(et&&et.visible){const nt=v(T,et,y,M);T.onBeforeShadow(r,T,A,P,D,nt,z),r.renderBufferDirect(P,null,D,nt,T,z),T.onAfterShadow(r,T,A,P,D,nt,z)}}}else if(U.visible){const k=v(T,U,y,M);T.onBeforeShadow(r,T,A,P,D,k,null),r.renderBufferDirect(P,null,D,k,T,null),T.onAfterShadow(r,T,A,P,D,k,null)}}const I=T.children;for(let D=0,U=I.length;D<U;D++)E(I[D],A,P,y,M)}function w(T){T.target.removeEventListener("dispose",w);for(const P in c){const y=c[P],M=T.target.uuid;M in y&&(y[M].dispose(),delete y[M])}}}function zg(r){function t(){let x=!1;const q=new Se;let G=null;const j=new Se(0,0,0,0);return{setMask:function(J){G!==J&&!x&&(r.colorMask(J,J,J,J),G=J)},setLocked:function(J){x=J},setClear:function(J,gt,At,ae,he){he===!0&&(J*=ae,gt*=ae,At*=ae),q.set(J,gt,At,ae),j.equals(q)===!1&&(r.clearColor(J,gt,At,ae),j.copy(q))},reset:function(){x=!1,G=null,j.set(-1,0,0,0)}}}function e(){let x=!1,q=null,G=null,j=null;return{setTest:function(J){J?ft(r.DEPTH_TEST):ct(r.DEPTH_TEST)},setMask:function(J){q!==J&&!x&&(r.depthMask(J),q=J)},setFunc:function(J){if(G!==J){switch(J){case rf:r.depthFunc(r.NEVER);break;case sf:r.depthFunc(r.ALWAYS);break;case af:r.depthFunc(r.LESS);break;case Is:r.depthFunc(r.LEQUAL);break;case of:r.depthFunc(r.EQUAL);break;case lf:r.depthFunc(r.GEQUAL);break;case cf:r.depthFunc(r.GREATER);break;case uf:r.depthFunc(r.NOTEQUAL);break;default:r.depthFunc(r.LEQUAL)}G=J}},setLocked:function(J){x=J},setClear:function(J){j!==J&&(r.clearDepth(J),j=J)},reset:function(){x=!1,q=null,G=null,j=null}}}function n(){let x=!1,q=null,G=null,j=null,J=null,gt=null,At=null,ae=null,he=null;return{setTest:function(Wt){x||(Wt?ft(r.STENCIL_TEST):ct(r.STENCIL_TEST))},setMask:function(Wt){q!==Wt&&!x&&(r.stencilMask(Wt),q=Wt)},setFunc:function(Wt,fe,de){(G!==Wt||j!==fe||J!==de)&&(r.stencilFunc(Wt,fe,de),G=Wt,j=fe,J=de)},setOp:function(Wt,fe,de){(gt!==Wt||At!==fe||ae!==de)&&(r.stencilOp(Wt,fe,de),gt=Wt,At=fe,ae=de)},setLocked:function(Wt){x=Wt},setClear:function(Wt){he!==Wt&&(r.clearStencil(Wt),he=Wt)},reset:function(){x=!1,q=null,G=null,j=null,J=null,gt=null,At=null,ae=null,he=null}}}const i=new t,s=new e,a=new n,o=new WeakMap,l=new WeakMap;let c={},u={},h=new WeakMap,f=[],d=null,g=!1,_=null,p=null,m=null,S=null,v=null,E=null,w=null,T=new Bt(0,0,0),A=0,P=!1,y=null,M=null,C=null,I=null,D=null;const U=r.getParameter(r.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let k=!1,O=0;const X=r.getParameter(r.VERSION);X.indexOf("WebGL")!==-1?(O=parseFloat(/^WebGL (\d)/.exec(X)[1]),k=O>=1):X.indexOf("OpenGL ES")!==-1&&(O=parseFloat(/^OpenGL ES (\d)/.exec(X)[1]),k=O>=2);let z=null,et={};const nt=r.getParameter(r.SCISSOR_BOX),lt=r.getParameter(r.VIEWPORT),Mt=new Se().fromArray(nt),Dt=new Se().fromArray(lt);function K(x,q,G,j){const J=new Uint8Array(4),gt=r.createTexture();r.bindTexture(x,gt),r.texParameteri(x,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(x,r.TEXTURE_MAG_FILTER,r.NEAREST);for(let At=0;At<G;At++)x===r.TEXTURE_3D||x===r.TEXTURE_2D_ARRAY?r.texImage3D(q,0,r.RGBA,1,1,j,0,r.RGBA,r.UNSIGNED_BYTE,J):r.texImage2D(q+At,0,r.RGBA,1,1,0,r.RGBA,r.UNSIGNED_BYTE,J);return gt}const Z={};Z[r.TEXTURE_2D]=K(r.TEXTURE_2D,r.TEXTURE_2D,1),Z[r.TEXTURE_CUBE_MAP]=K(r.TEXTURE_CUBE_MAP,r.TEXTURE_CUBE_MAP_POSITIVE_X,6),Z[r.TEXTURE_2D_ARRAY]=K(r.TEXTURE_2D_ARRAY,r.TEXTURE_2D_ARRAY,1,1),Z[r.TEXTURE_3D]=K(r.TEXTURE_3D,r.TEXTURE_3D,1,1),i.setClear(0,0,0,1),s.setClear(1),a.setClear(0),ft(r.DEPTH_TEST),s.setFunc(Is),xt(!1),Gt(il),ft(r.CULL_FACE),zt(ei);function ft(x){c[x]!==!0&&(r.enable(x),c[x]=!0)}function ct(x){c[x]!==!1&&(r.disable(x),c[x]=!1)}function Nt(x,q){return u[x]!==q?(r.bindFramebuffer(x,q),u[x]=q,x===r.DRAW_FRAMEBUFFER&&(u[r.FRAMEBUFFER]=q),x===r.FRAMEBUFFER&&(u[r.DRAW_FRAMEBUFFER]=q),!0):!1}function wt(x,q){let G=f,j=!1;if(x){G=h.get(q),G===void 0&&(G=[],h.set(q,G));const J=x.textures;if(G.length!==J.length||G[0]!==r.COLOR_ATTACHMENT0){for(let gt=0,At=J.length;gt<At;gt++)G[gt]=r.COLOR_ATTACHMENT0+gt;G.length=J.length,j=!0}}else G[0]!==r.BACK&&(G[0]=r.BACK,j=!0);j&&r.drawBuffers(G)}function kt(x){return d!==x?(r.useProgram(x),d=x,!0):!1}const N={[Ai]:r.FUNC_ADD,[kh]:r.FUNC_SUBTRACT,[Hh]:r.FUNC_REVERSE_SUBTRACT};N[Gh]=r.MIN,N[Vh]=r.MAX;const Ht={[Wh]:r.ZERO,[Xh]:r.ONE,[Yh]:r.SRC_COLOR,[to]:r.SRC_ALPHA,[Jh]:r.SRC_ALPHA_SATURATE,[$h]:r.DST_COLOR,[jh]:r.DST_ALPHA,[qh]:r.ONE_MINUS_SRC_COLOR,[eo]:r.ONE_MINUS_SRC_ALPHA,[Zh]:r.ONE_MINUS_DST_COLOR,[Kh]:r.ONE_MINUS_DST_ALPHA,[Qh]:r.CONSTANT_COLOR,[tf]:r.ONE_MINUS_CONSTANT_COLOR,[ef]:r.CONSTANT_ALPHA,[nf]:r.ONE_MINUS_CONSTANT_ALPHA};function zt(x,q,G,j,J,gt,At,ae,he,Wt){if(x===ei){g===!0&&(ct(r.BLEND),g=!1);return}if(g===!1&&(ft(r.BLEND),g=!0),x!==zh){if(x!==_||Wt!==P){if((p!==Ai||v!==Ai)&&(r.blendEquation(r.FUNC_ADD),p=Ai,v=Ai),Wt)switch(x){case lr:r.blendFuncSeparate(r.ONE,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case Qa:r.blendFunc(r.ONE,r.ONE);break;case rl:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case sl:r.blendFuncSeparate(r.ZERO,r.SRC_COLOR,r.ZERO,r.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",x);break}else switch(x){case lr:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case Qa:r.blendFunc(r.SRC_ALPHA,r.ONE);break;case rl:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case sl:r.blendFunc(r.ZERO,r.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",x);break}m=null,S=null,E=null,w=null,T.set(0,0,0),A=0,_=x,P=Wt}return}J=J||q,gt=gt||G,At=At||j,(q!==p||J!==v)&&(r.blendEquationSeparate(N[q],N[J]),p=q,v=J),(G!==m||j!==S||gt!==E||At!==w)&&(r.blendFuncSeparate(Ht[G],Ht[j],Ht[gt],Ht[At]),m=G,S=j,E=gt,w=At),(ae.equals(T)===!1||he!==A)&&(r.blendColor(ae.r,ae.g,ae.b,he),T.copy(ae),A=he),_=x,P=!1}function Zt(x,q){x.side===On?ct(r.CULL_FACE):ft(r.CULL_FACE);let G=x.side===Be;q&&(G=!G),xt(G),x.blending===lr&&x.transparent===!1?zt(ei):zt(x.blending,x.blendEquation,x.blendSrc,x.blendDst,x.blendEquationAlpha,x.blendSrcAlpha,x.blendDstAlpha,x.blendColor,x.blendAlpha,x.premultipliedAlpha),s.setFunc(x.depthFunc),s.setTest(x.depthTest),s.setMask(x.depthWrite),i.setMask(x.colorWrite);const j=x.stencilWrite;a.setTest(j),j&&(a.setMask(x.stencilWriteMask),a.setFunc(x.stencilFunc,x.stencilRef,x.stencilFuncMask),a.setOp(x.stencilFail,x.stencilZFail,x.stencilZPass)),Rt(x.polygonOffset,x.polygonOffsetFactor,x.polygonOffsetUnits),x.alphaToCoverage===!0?ft(r.SAMPLE_ALPHA_TO_COVERAGE):ct(r.SAMPLE_ALPHA_TO_COVERAGE)}function xt(x){y!==x&&(x?r.frontFace(r.CW):r.frontFace(r.CCW),y=x)}function Gt(x){x!==Oh?(ft(r.CULL_FACE),x!==M&&(x===il?r.cullFace(r.BACK):x===Fh?r.cullFace(r.FRONT):r.cullFace(r.FRONT_AND_BACK))):ct(r.CULL_FACE),M=x}function Ot(x){x!==C&&(k&&r.lineWidth(x),C=x)}function Rt(x,q,G){x?(ft(r.POLYGON_OFFSET_FILL),(I!==q||D!==G)&&(r.polygonOffset(q,G),I=q,D=G)):ct(r.POLYGON_OFFSET_FILL)}function te(x){x?ft(r.SCISSOR_TEST):ct(r.SCISSOR_TEST)}function L(x){x===void 0&&(x=r.TEXTURE0+U-1),z!==x&&(r.activeTexture(x),z=x)}function b(x,q,G){G===void 0&&(z===null?G=r.TEXTURE0+U-1:G=z);let j=et[G];j===void 0&&(j={type:void 0,texture:void 0},et[G]=j),(j.type!==x||j.texture!==q)&&(z!==G&&(r.activeTexture(G),z=G),r.bindTexture(x,q||Z[x]),j.type=x,j.texture=q)}function Y(){const x=et[z];x!==void 0&&x.type!==void 0&&(r.bindTexture(x.type,null),x.type=void 0,x.texture=void 0)}function $(){try{r.compressedTexImage2D.apply(r,arguments)}catch(x){console.error("THREE.WebGLState:",x)}}function Q(){try{r.compressedTexImage3D.apply(r,arguments)}catch(x){console.error("THREE.WebGLState:",x)}}function tt(){try{r.texSubImage2D.apply(r,arguments)}catch(x){console.error("THREE.WebGLState:",x)}}function _t(){try{r.texSubImage3D.apply(r,arguments)}catch(x){console.error("THREE.WebGLState:",x)}}function at(){try{r.compressedTexSubImage2D.apply(r,arguments)}catch(x){console.error("THREE.WebGLState:",x)}}function st(){try{r.compressedTexSubImage3D.apply(r,arguments)}catch(x){console.error("THREE.WebGLState:",x)}}function Ct(){try{r.texStorage2D.apply(r,arguments)}catch(x){console.error("THREE.WebGLState:",x)}}function it(){try{r.texStorage3D.apply(r,arguments)}catch(x){console.error("THREE.WebGLState:",x)}}function pt(){try{r.texImage2D.apply(r,arguments)}catch(x){console.error("THREE.WebGLState:",x)}}function Ft(){try{r.texImage3D.apply(r,arguments)}catch(x){console.error("THREE.WebGLState:",x)}}function yt(x){Mt.equals(x)===!1&&(r.scissor(x.x,x.y,x.z,x.w),Mt.copy(x))}function ut(x){Dt.equals(x)===!1&&(r.viewport(x.x,x.y,x.z,x.w),Dt.copy(x))}function Pt(x,q){let G=l.get(q);G===void 0&&(G=new WeakMap,l.set(q,G));let j=G.get(x);j===void 0&&(j=r.getUniformBlockIndex(q,x.name),G.set(x,j))}function Lt(x,q){const j=l.get(q).get(x);o.get(q)!==j&&(r.uniformBlockBinding(q,j,x.__bindingPointIndex),o.set(q,j))}function se(){r.disable(r.BLEND),r.disable(r.CULL_FACE),r.disable(r.DEPTH_TEST),r.disable(r.POLYGON_OFFSET_FILL),r.disable(r.SCISSOR_TEST),r.disable(r.STENCIL_TEST),r.disable(r.SAMPLE_ALPHA_TO_COVERAGE),r.blendEquation(r.FUNC_ADD),r.blendFunc(r.ONE,r.ZERO),r.blendFuncSeparate(r.ONE,r.ZERO,r.ONE,r.ZERO),r.blendColor(0,0,0,0),r.colorMask(!0,!0,!0,!0),r.clearColor(0,0,0,0),r.depthMask(!0),r.depthFunc(r.LESS),r.clearDepth(1),r.stencilMask(4294967295),r.stencilFunc(r.ALWAYS,0,4294967295),r.stencilOp(r.KEEP,r.KEEP,r.KEEP),r.clearStencil(0),r.cullFace(r.BACK),r.frontFace(r.CCW),r.polygonOffset(0,0),r.activeTexture(r.TEXTURE0),r.bindFramebuffer(r.FRAMEBUFFER,null),r.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),r.bindFramebuffer(r.READ_FRAMEBUFFER,null),r.useProgram(null),r.lineWidth(1),r.scissor(0,0,r.canvas.width,r.canvas.height),r.viewport(0,0,r.canvas.width,r.canvas.height),c={},z=null,et={},u={},h=new WeakMap,f=[],d=null,g=!1,_=null,p=null,m=null,S=null,v=null,E=null,w=null,T=new Bt(0,0,0),A=0,P=!1,y=null,M=null,C=null,I=null,D=null,Mt.set(0,0,r.canvas.width,r.canvas.height),Dt.set(0,0,r.canvas.width,r.canvas.height),i.reset(),s.reset(),a.reset()}return{buffers:{color:i,depth:s,stencil:a},enable:ft,disable:ct,bindFramebuffer:Nt,drawBuffers:wt,useProgram:kt,setBlending:zt,setMaterial:Zt,setFlipSided:xt,setCullFace:Gt,setLineWidth:Ot,setPolygonOffset:Rt,setScissorTest:te,activeTexture:L,bindTexture:b,unbindTexture:Y,compressedTexImage2D:$,compressedTexImage3D:Q,texImage2D:pt,texImage3D:Ft,updateUBOMapping:Pt,uniformBlockBinding:Lt,texStorage2D:Ct,texStorage3D:it,texSubImage2D:tt,texSubImage3D:_t,compressedTexSubImage2D:at,compressedTexSubImage3D:st,scissor:yt,viewport:ut,reset:se}}function kg(r,t,e,n,i,s,a){const o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new bt,u=new WeakMap;let h;const f=new WeakMap;let d=!1;try{d=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(L,b){return d?new OffscreenCanvas(L,b):Gr("canvas")}function _(L,b,Y){let $=1;const Q=te(L);if((Q.width>Y||Q.height>Y)&&($=Y/Math.max(Q.width,Q.height)),$<1)if(typeof HTMLImageElement<"u"&&L instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&L instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&L instanceof ImageBitmap||typeof VideoFrame<"u"&&L instanceof VideoFrame){const tt=Math.floor($*Q.width),_t=Math.floor($*Q.height);h===void 0&&(h=g(tt,_t));const at=b?g(tt,_t):h;return at.width=tt,at.height=_t,at.getContext("2d").drawImage(L,0,0,tt,_t),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+Q.width+"x"+Q.height+") to ("+tt+"x"+_t+")."),at}else return"data"in L&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+Q.width+"x"+Q.height+")."),L;return L}function p(L){return L.generateMipmaps&&L.minFilter!==ln&&L.minFilter!==on}function m(L){r.generateMipmap(L)}function S(L,b,Y,$,Q=!1){if(L!==null){if(r[L]!==void 0)return r[L];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+L+"'")}let tt=b;if(b===r.RED&&(Y===r.FLOAT&&(tt=r.R32F),Y===r.HALF_FLOAT&&(tt=r.R16F),Y===r.UNSIGNED_BYTE&&(tt=r.R8)),b===r.RED_INTEGER&&(Y===r.UNSIGNED_BYTE&&(tt=r.R8UI),Y===r.UNSIGNED_SHORT&&(tt=r.R16UI),Y===r.UNSIGNED_INT&&(tt=r.R32UI),Y===r.BYTE&&(tt=r.R8I),Y===r.SHORT&&(tt=r.R16I),Y===r.INT&&(tt=r.R32I)),b===r.RG&&(Y===r.FLOAT&&(tt=r.RG32F),Y===r.HALF_FLOAT&&(tt=r.RG16F),Y===r.UNSIGNED_BYTE&&(tt=r.RG8)),b===r.RG_INTEGER&&(Y===r.UNSIGNED_BYTE&&(tt=r.RG8UI),Y===r.UNSIGNED_SHORT&&(tt=r.RG16UI),Y===r.UNSIGNED_INT&&(tt=r.RG32UI),Y===r.BYTE&&(tt=r.RG8I),Y===r.SHORT&&(tt=r.RG16I),Y===r.INT&&(tt=r.RG32I)),b===r.RGB&&Y===r.UNSIGNED_INT_5_9_9_9_REV&&(tt=r.RGB9_E5),b===r.RGBA){const _t=Q?Ns:qt.getTransfer($);Y===r.FLOAT&&(tt=r.RGBA32F),Y===r.HALF_FLOAT&&(tt=r.RGBA16F),Y===r.UNSIGNED_BYTE&&(tt=_t===Jt?r.SRGB8_ALPHA8:r.RGBA8),Y===r.UNSIGNED_SHORT_4_4_4_4&&(tt=r.RGBA4),Y===r.UNSIGNED_SHORT_5_5_5_1&&(tt=r.RGB5_A1)}return(tt===r.R16F||tt===r.R32F||tt===r.RG16F||tt===r.RG32F||tt===r.RGBA16F||tt===r.RGBA32F)&&t.get("EXT_color_buffer_float"),tt}function v(L,b){let Y;return L?b===null||b===_r||b===gr?Y=r.DEPTH24_STENCIL8:b===Zn?Y=r.DEPTH32F_STENCIL8:b===Us&&(Y=r.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):b===null||b===_r||b===gr?Y=r.DEPTH_COMPONENT24:b===Zn?Y=r.DEPTH_COMPONENT32F:b===Us&&(Y=r.DEPTH_COMPONENT16),Y}function E(L,b){return p(L)===!0||L.isFramebufferTexture&&L.minFilter!==ln&&L.minFilter!==on?Math.log2(Math.max(b.width,b.height))+1:L.mipmaps!==void 0&&L.mipmaps.length>0?L.mipmaps.length:L.isCompressedTexture&&Array.isArray(L.image)?b.mipmaps.length:1}function w(L){const b=L.target;b.removeEventListener("dispose",w),A(b),b.isVideoTexture&&u.delete(b)}function T(L){const b=L.target;b.removeEventListener("dispose",T),y(b)}function A(L){const b=n.get(L);if(b.__webglInit===void 0)return;const Y=L.source,$=f.get(Y);if($){const Q=$[b.__cacheKey];Q.usedTimes--,Q.usedTimes===0&&P(L),Object.keys($).length===0&&f.delete(Y)}n.remove(L)}function P(L){const b=n.get(L);r.deleteTexture(b.__webglTexture);const Y=L.source,$=f.get(Y);delete $[b.__cacheKey],a.memory.textures--}function y(L){const b=n.get(L);if(L.depthTexture&&L.depthTexture.dispose(),L.isWebGLCubeRenderTarget)for(let $=0;$<6;$++){if(Array.isArray(b.__webglFramebuffer[$]))for(let Q=0;Q<b.__webglFramebuffer[$].length;Q++)r.deleteFramebuffer(b.__webglFramebuffer[$][Q]);else r.deleteFramebuffer(b.__webglFramebuffer[$]);b.__webglDepthbuffer&&r.deleteRenderbuffer(b.__webglDepthbuffer[$])}else{if(Array.isArray(b.__webglFramebuffer))for(let $=0;$<b.__webglFramebuffer.length;$++)r.deleteFramebuffer(b.__webglFramebuffer[$]);else r.deleteFramebuffer(b.__webglFramebuffer);if(b.__webglDepthbuffer&&r.deleteRenderbuffer(b.__webglDepthbuffer),b.__webglMultisampledFramebuffer&&r.deleteFramebuffer(b.__webglMultisampledFramebuffer),b.__webglColorRenderbuffer)for(let $=0;$<b.__webglColorRenderbuffer.length;$++)b.__webglColorRenderbuffer[$]&&r.deleteRenderbuffer(b.__webglColorRenderbuffer[$]);b.__webglDepthRenderbuffer&&r.deleteRenderbuffer(b.__webglDepthRenderbuffer)}const Y=L.textures;for(let $=0,Q=Y.length;$<Q;$++){const tt=n.get(Y[$]);tt.__webglTexture&&(r.deleteTexture(tt.__webglTexture),a.memory.textures--),n.remove(Y[$])}n.remove(L)}let M=0;function C(){M=0}function I(){const L=M;return L>=i.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+L+" texture units while this GPU supports only "+i.maxTextures),M+=1,L}function D(L){const b=[];return b.push(L.wrapS),b.push(L.wrapT),b.push(L.wrapR||0),b.push(L.magFilter),b.push(L.minFilter),b.push(L.anisotropy),b.push(L.internalFormat),b.push(L.format),b.push(L.type),b.push(L.generateMipmaps),b.push(L.premultiplyAlpha),b.push(L.flipY),b.push(L.unpackAlignment),b.push(L.colorSpace),b.join()}function U(L,b){const Y=n.get(L);if(L.isVideoTexture&&Ot(L),L.isRenderTargetTexture===!1&&L.version>0&&Y.__version!==L.version){const $=L.image;if($===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if($.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Dt(Y,L,b);return}}e.bindTexture(r.TEXTURE_2D,Y.__webglTexture,r.TEXTURE0+b)}function k(L,b){const Y=n.get(L);if(L.version>0&&Y.__version!==L.version){Dt(Y,L,b);return}e.bindTexture(r.TEXTURE_2D_ARRAY,Y.__webglTexture,r.TEXTURE0+b)}function O(L,b){const Y=n.get(L);if(L.version>0&&Y.__version!==L.version){Dt(Y,L,b);return}e.bindTexture(r.TEXTURE_3D,Y.__webglTexture,r.TEXTURE0+b)}function X(L,b){const Y=n.get(L);if(L.version>0&&Y.__version!==L.version){K(Y,L,b);return}e.bindTexture(r.TEXTURE_CUBE_MAP,Y.__webglTexture,r.TEXTURE0+b)}const z={[ro]:r.REPEAT,[Ri]:r.CLAMP_TO_EDGE,[so]:r.MIRRORED_REPEAT},et={[ln]:r.NEAREST,[Mf]:r.NEAREST_MIPMAP_NEAREST,[ns]:r.NEAREST_MIPMAP_LINEAR,[on]:r.LINEAR,[la]:r.LINEAR_MIPMAP_NEAREST,[$n]:r.LINEAR_MIPMAP_LINEAR},nt={[Uf]:r.NEVER,[kf]:r.ALWAYS,[Nf]:r.LESS,[hu]:r.LEQUAL,[Of]:r.EQUAL,[zf]:r.GEQUAL,[Ff]:r.GREATER,[Bf]:r.NOTEQUAL};function lt(L,b){if(b.type===Zn&&t.has("OES_texture_float_linear")===!1&&(b.magFilter===on||b.magFilter===la||b.magFilter===ns||b.magFilter===$n||b.minFilter===on||b.minFilter===la||b.minFilter===ns||b.minFilter===$n)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),r.texParameteri(L,r.TEXTURE_WRAP_S,z[b.wrapS]),r.texParameteri(L,r.TEXTURE_WRAP_T,z[b.wrapT]),(L===r.TEXTURE_3D||L===r.TEXTURE_2D_ARRAY)&&r.texParameteri(L,r.TEXTURE_WRAP_R,z[b.wrapR]),r.texParameteri(L,r.TEXTURE_MAG_FILTER,et[b.magFilter]),r.texParameteri(L,r.TEXTURE_MIN_FILTER,et[b.minFilter]),b.compareFunction&&(r.texParameteri(L,r.TEXTURE_COMPARE_MODE,r.COMPARE_REF_TO_TEXTURE),r.texParameteri(L,r.TEXTURE_COMPARE_FUNC,nt[b.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(b.magFilter===ln||b.minFilter!==ns&&b.minFilter!==$n||b.type===Zn&&t.has("OES_texture_float_linear")===!1)return;if(b.anisotropy>1||n.get(b).__currentAnisotropy){const Y=t.get("EXT_texture_filter_anisotropic");r.texParameterf(L,Y.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(b.anisotropy,i.getMaxAnisotropy())),n.get(b).__currentAnisotropy=b.anisotropy}}}function Mt(L,b){let Y=!1;L.__webglInit===void 0&&(L.__webglInit=!0,b.addEventListener("dispose",w));const $=b.source;let Q=f.get($);Q===void 0&&(Q={},f.set($,Q));const tt=D(b);if(tt!==L.__cacheKey){Q[tt]===void 0&&(Q[tt]={texture:r.createTexture(),usedTimes:0},a.memory.textures++,Y=!0),Q[tt].usedTimes++;const _t=Q[L.__cacheKey];_t!==void 0&&(Q[L.__cacheKey].usedTimes--,_t.usedTimes===0&&P(b)),L.__cacheKey=tt,L.__webglTexture=Q[tt].texture}return Y}function Dt(L,b,Y){let $=r.TEXTURE_2D;(b.isDataArrayTexture||b.isCompressedArrayTexture)&&($=r.TEXTURE_2D_ARRAY),b.isData3DTexture&&($=r.TEXTURE_3D);const Q=Mt(L,b),tt=b.source;e.bindTexture($,L.__webglTexture,r.TEXTURE0+Y);const _t=n.get(tt);if(tt.version!==_t.__version||Q===!0){e.activeTexture(r.TEXTURE0+Y);const at=qt.getPrimaries(qt.workingColorSpace),st=b.colorSpace===Fn?null:qt.getPrimaries(b.colorSpace),Ct=b.colorSpace===Fn||at===st?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,b.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,b.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ct);let it=_(b.image,!1,i.maxTextureSize);it=Rt(b,it);const pt=s.convert(b.format,b.colorSpace),Ft=s.convert(b.type);let yt=S(b.internalFormat,pt,Ft,b.colorSpace,b.isVideoTexture);lt($,b);let ut;const Pt=b.mipmaps,Lt=b.isVideoTexture!==!0,se=_t.__version===void 0||Q===!0,x=tt.dataReady,q=E(b,it);if(b.isDepthTexture)yt=v(b.format===vr,b.type),se&&(Lt?e.texStorage2D(r.TEXTURE_2D,1,yt,it.width,it.height):e.texImage2D(r.TEXTURE_2D,0,yt,it.width,it.height,0,pt,Ft,null));else if(b.isDataTexture)if(Pt.length>0){Lt&&se&&e.texStorage2D(r.TEXTURE_2D,q,yt,Pt[0].width,Pt[0].height);for(let G=0,j=Pt.length;G<j;G++)ut=Pt[G],Lt?x&&e.texSubImage2D(r.TEXTURE_2D,G,0,0,ut.width,ut.height,pt,Ft,ut.data):e.texImage2D(r.TEXTURE_2D,G,yt,ut.width,ut.height,0,pt,Ft,ut.data);b.generateMipmaps=!1}else Lt?(se&&e.texStorage2D(r.TEXTURE_2D,q,yt,it.width,it.height),x&&e.texSubImage2D(r.TEXTURE_2D,0,0,0,it.width,it.height,pt,Ft,it.data)):e.texImage2D(r.TEXTURE_2D,0,yt,it.width,it.height,0,pt,Ft,it.data);else if(b.isCompressedTexture)if(b.isCompressedArrayTexture){Lt&&se&&e.texStorage3D(r.TEXTURE_2D_ARRAY,q,yt,Pt[0].width,Pt[0].height,it.depth);for(let G=0,j=Pt.length;G<j;G++)if(ut=Pt[G],b.format!==yn)if(pt!==null)if(Lt){if(x)if(b.layerUpdates.size>0){for(const J of b.layerUpdates){const gt=ut.width*ut.height;e.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,G,0,0,J,ut.width,ut.height,1,pt,ut.data.slice(gt*J,gt*(J+1)),0,0)}b.clearLayerUpdates()}else e.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,G,0,0,0,ut.width,ut.height,it.depth,pt,ut.data,0,0)}else e.compressedTexImage3D(r.TEXTURE_2D_ARRAY,G,yt,ut.width,ut.height,it.depth,0,ut.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Lt?x&&e.texSubImage3D(r.TEXTURE_2D_ARRAY,G,0,0,0,ut.width,ut.height,it.depth,pt,Ft,ut.data):e.texImage3D(r.TEXTURE_2D_ARRAY,G,yt,ut.width,ut.height,it.depth,0,pt,Ft,ut.data)}else{Lt&&se&&e.texStorage2D(r.TEXTURE_2D,q,yt,Pt[0].width,Pt[0].height);for(let G=0,j=Pt.length;G<j;G++)ut=Pt[G],b.format!==yn?pt!==null?Lt?x&&e.compressedTexSubImage2D(r.TEXTURE_2D,G,0,0,ut.width,ut.height,pt,ut.data):e.compressedTexImage2D(r.TEXTURE_2D,G,yt,ut.width,ut.height,0,ut.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Lt?x&&e.texSubImage2D(r.TEXTURE_2D,G,0,0,ut.width,ut.height,pt,Ft,ut.data):e.texImage2D(r.TEXTURE_2D,G,yt,ut.width,ut.height,0,pt,Ft,ut.data)}else if(b.isDataArrayTexture)if(Lt){if(se&&e.texStorage3D(r.TEXTURE_2D_ARRAY,q,yt,it.width,it.height,it.depth),x)if(b.layerUpdates.size>0){let G;switch(Ft){case r.UNSIGNED_BYTE:switch(pt){case r.ALPHA:G=1;break;case r.LUMINANCE:G=1;break;case r.LUMINANCE_ALPHA:G=2;break;case r.RGB:G=3;break;case r.RGBA:G=4;break;default:throw new Error(`Unknown texel size for format ${pt}.`)}break;case r.UNSIGNED_SHORT_4_4_4_4:case r.UNSIGNED_SHORT_5_5_5_1:case r.UNSIGNED_SHORT_5_6_5:G=1;break;default:throw new Error(`Unknown texel size for type ${Ft}.`)}const j=it.width*it.height*G;for(const J of b.layerUpdates)e.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,J,it.width,it.height,1,pt,Ft,it.data.slice(j*J,j*(J+1)));b.clearLayerUpdates()}else e.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,0,it.width,it.height,it.depth,pt,Ft,it.data)}else e.texImage3D(r.TEXTURE_2D_ARRAY,0,yt,it.width,it.height,it.depth,0,pt,Ft,it.data);else if(b.isData3DTexture)Lt?(se&&e.texStorage3D(r.TEXTURE_3D,q,yt,it.width,it.height,it.depth),x&&e.texSubImage3D(r.TEXTURE_3D,0,0,0,0,it.width,it.height,it.depth,pt,Ft,it.data)):e.texImage3D(r.TEXTURE_3D,0,yt,it.width,it.height,it.depth,0,pt,Ft,it.data);else if(b.isFramebufferTexture){if(se)if(Lt)e.texStorage2D(r.TEXTURE_2D,q,yt,it.width,it.height);else{let G=it.width,j=it.height;for(let J=0;J<q;J++)e.texImage2D(r.TEXTURE_2D,J,yt,G,j,0,pt,Ft,null),G>>=1,j>>=1}}else if(Pt.length>0){if(Lt&&se){const G=te(Pt[0]);e.texStorage2D(r.TEXTURE_2D,q,yt,G.width,G.height)}for(let G=0,j=Pt.length;G<j;G++)ut=Pt[G],Lt?x&&e.texSubImage2D(r.TEXTURE_2D,G,0,0,pt,Ft,ut):e.texImage2D(r.TEXTURE_2D,G,yt,pt,Ft,ut);b.generateMipmaps=!1}else if(Lt){if(se){const G=te(it);e.texStorage2D(r.TEXTURE_2D,q,yt,G.width,G.height)}x&&e.texSubImage2D(r.TEXTURE_2D,0,0,0,pt,Ft,it)}else e.texImage2D(r.TEXTURE_2D,0,yt,pt,Ft,it);p(b)&&m($),_t.__version=tt.version,b.onUpdate&&b.onUpdate(b)}L.__version=b.version}function K(L,b,Y){if(b.image.length!==6)return;const $=Mt(L,b),Q=b.source;e.bindTexture(r.TEXTURE_CUBE_MAP,L.__webglTexture,r.TEXTURE0+Y);const tt=n.get(Q);if(Q.version!==tt.__version||$===!0){e.activeTexture(r.TEXTURE0+Y);const _t=qt.getPrimaries(qt.workingColorSpace),at=b.colorSpace===Fn?null:qt.getPrimaries(b.colorSpace),st=b.colorSpace===Fn||_t===at?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,b.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,b.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,st);const Ct=b.isCompressedTexture||b.image[0].isCompressedTexture,it=b.image[0]&&b.image[0].isDataTexture,pt=[];for(let j=0;j<6;j++)!Ct&&!it?pt[j]=_(b.image[j],!0,i.maxCubemapSize):pt[j]=it?b.image[j].image:b.image[j],pt[j]=Rt(b,pt[j]);const Ft=pt[0],yt=s.convert(b.format,b.colorSpace),ut=s.convert(b.type),Pt=S(b.internalFormat,yt,ut,b.colorSpace),Lt=b.isVideoTexture!==!0,se=tt.__version===void 0||$===!0,x=Q.dataReady;let q=E(b,Ft);lt(r.TEXTURE_CUBE_MAP,b);let G;if(Ct){Lt&&se&&e.texStorage2D(r.TEXTURE_CUBE_MAP,q,Pt,Ft.width,Ft.height);for(let j=0;j<6;j++){G=pt[j].mipmaps;for(let J=0;J<G.length;J++){const gt=G[J];b.format!==yn?yt!==null?Lt?x&&e.compressedTexSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+j,J,0,0,gt.width,gt.height,yt,gt.data):e.compressedTexImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+j,J,Pt,gt.width,gt.height,0,gt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Lt?x&&e.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+j,J,0,0,gt.width,gt.height,yt,ut,gt.data):e.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+j,J,Pt,gt.width,gt.height,0,yt,ut,gt.data)}}}else{if(G=b.mipmaps,Lt&&se){G.length>0&&q++;const j=te(pt[0]);e.texStorage2D(r.TEXTURE_CUBE_MAP,q,Pt,j.width,j.height)}for(let j=0;j<6;j++)if(it){Lt?x&&e.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,pt[j].width,pt[j].height,yt,ut,pt[j].data):e.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,Pt,pt[j].width,pt[j].height,0,yt,ut,pt[j].data);for(let J=0;J<G.length;J++){const At=G[J].image[j].image;Lt?x&&e.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+j,J+1,0,0,At.width,At.height,yt,ut,At.data):e.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+j,J+1,Pt,At.width,At.height,0,yt,ut,At.data)}}else{Lt?x&&e.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,yt,ut,pt[j]):e.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,Pt,yt,ut,pt[j]);for(let J=0;J<G.length;J++){const gt=G[J];Lt?x&&e.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+j,J+1,0,0,yt,ut,gt.image[j]):e.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+j,J+1,Pt,yt,ut,gt.image[j])}}}p(b)&&m(r.TEXTURE_CUBE_MAP),tt.__version=Q.version,b.onUpdate&&b.onUpdate(b)}L.__version=b.version}function Z(L,b,Y,$,Q,tt){const _t=s.convert(Y.format,Y.colorSpace),at=s.convert(Y.type),st=S(Y.internalFormat,_t,at,Y.colorSpace);if(!n.get(b).__hasExternalTextures){const it=Math.max(1,b.width>>tt),pt=Math.max(1,b.height>>tt);Q===r.TEXTURE_3D||Q===r.TEXTURE_2D_ARRAY?e.texImage3D(Q,tt,st,it,pt,b.depth,0,_t,at,null):e.texImage2D(Q,tt,st,it,pt,0,_t,at,null)}e.bindFramebuffer(r.FRAMEBUFFER,L),Gt(b)?o.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,$,Q,n.get(Y).__webglTexture,0,xt(b)):(Q===r.TEXTURE_2D||Q>=r.TEXTURE_CUBE_MAP_POSITIVE_X&&Q<=r.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&r.framebufferTexture2D(r.FRAMEBUFFER,$,Q,n.get(Y).__webglTexture,tt),e.bindFramebuffer(r.FRAMEBUFFER,null)}function ft(L,b,Y){if(r.bindRenderbuffer(r.RENDERBUFFER,L),b.depthBuffer){const $=b.depthTexture,Q=$&&$.isDepthTexture?$.type:null,tt=v(b.stencilBuffer,Q),_t=b.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,at=xt(b);Gt(b)?o.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,at,tt,b.width,b.height):Y?r.renderbufferStorageMultisample(r.RENDERBUFFER,at,tt,b.width,b.height):r.renderbufferStorage(r.RENDERBUFFER,tt,b.width,b.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,_t,r.RENDERBUFFER,L)}else{const $=b.textures;for(let Q=0;Q<$.length;Q++){const tt=$[Q],_t=s.convert(tt.format,tt.colorSpace),at=s.convert(tt.type),st=S(tt.internalFormat,_t,at,tt.colorSpace),Ct=xt(b);Y&&Gt(b)===!1?r.renderbufferStorageMultisample(r.RENDERBUFFER,Ct,st,b.width,b.height):Gt(b)?o.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,Ct,st,b.width,b.height):r.renderbufferStorage(r.RENDERBUFFER,st,b.width,b.height)}}r.bindRenderbuffer(r.RENDERBUFFER,null)}function ct(L,b){if(b&&b.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(r.FRAMEBUFFER,L),!(b.depthTexture&&b.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!n.get(b.depthTexture).__webglTexture||b.depthTexture.image.width!==b.width||b.depthTexture.image.height!==b.height)&&(b.depthTexture.image.width=b.width,b.depthTexture.image.height=b.height,b.depthTexture.needsUpdate=!0),U(b.depthTexture,0);const $=n.get(b.depthTexture).__webglTexture,Q=xt(b);if(b.depthTexture.format===cr)Gt(b)?o.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.TEXTURE_2D,$,0,Q):r.framebufferTexture2D(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.TEXTURE_2D,$,0);else if(b.depthTexture.format===vr)Gt(b)?o.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,r.DEPTH_STENCIL_ATTACHMENT,r.TEXTURE_2D,$,0,Q):r.framebufferTexture2D(r.FRAMEBUFFER,r.DEPTH_STENCIL_ATTACHMENT,r.TEXTURE_2D,$,0);else throw new Error("Unknown depthTexture format")}function Nt(L){const b=n.get(L),Y=L.isWebGLCubeRenderTarget===!0;if(L.depthTexture&&!b.__autoAllocateDepthBuffer){if(Y)throw new Error("target.depthTexture not supported in Cube render targets");ct(b.__webglFramebuffer,L)}else if(Y){b.__webglDepthbuffer=[];for(let $=0;$<6;$++)e.bindFramebuffer(r.FRAMEBUFFER,b.__webglFramebuffer[$]),b.__webglDepthbuffer[$]=r.createRenderbuffer(),ft(b.__webglDepthbuffer[$],L,!1)}else e.bindFramebuffer(r.FRAMEBUFFER,b.__webglFramebuffer),b.__webglDepthbuffer=r.createRenderbuffer(),ft(b.__webglDepthbuffer,L,!1);e.bindFramebuffer(r.FRAMEBUFFER,null)}function wt(L,b,Y){const $=n.get(L);b!==void 0&&Z($.__webglFramebuffer,L,L.texture,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,0),Y!==void 0&&Nt(L)}function kt(L){const b=L.texture,Y=n.get(L),$=n.get(b);L.addEventListener("dispose",T);const Q=L.textures,tt=L.isWebGLCubeRenderTarget===!0,_t=Q.length>1;if(_t||($.__webglTexture===void 0&&($.__webglTexture=r.createTexture()),$.__version=b.version,a.memory.textures++),tt){Y.__webglFramebuffer=[];for(let at=0;at<6;at++)if(b.mipmaps&&b.mipmaps.length>0){Y.__webglFramebuffer[at]=[];for(let st=0;st<b.mipmaps.length;st++)Y.__webglFramebuffer[at][st]=r.createFramebuffer()}else Y.__webglFramebuffer[at]=r.createFramebuffer()}else{if(b.mipmaps&&b.mipmaps.length>0){Y.__webglFramebuffer=[];for(let at=0;at<b.mipmaps.length;at++)Y.__webglFramebuffer[at]=r.createFramebuffer()}else Y.__webglFramebuffer=r.createFramebuffer();if(_t)for(let at=0,st=Q.length;at<st;at++){const Ct=n.get(Q[at]);Ct.__webglTexture===void 0&&(Ct.__webglTexture=r.createTexture(),a.memory.textures++)}if(L.samples>0&&Gt(L)===!1){Y.__webglMultisampledFramebuffer=r.createFramebuffer(),Y.__webglColorRenderbuffer=[],e.bindFramebuffer(r.FRAMEBUFFER,Y.__webglMultisampledFramebuffer);for(let at=0;at<Q.length;at++){const st=Q[at];Y.__webglColorRenderbuffer[at]=r.createRenderbuffer(),r.bindRenderbuffer(r.RENDERBUFFER,Y.__webglColorRenderbuffer[at]);const Ct=s.convert(st.format,st.colorSpace),it=s.convert(st.type),pt=S(st.internalFormat,Ct,it,st.colorSpace,L.isXRRenderTarget===!0),Ft=xt(L);r.renderbufferStorageMultisample(r.RENDERBUFFER,Ft,pt,L.width,L.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+at,r.RENDERBUFFER,Y.__webglColorRenderbuffer[at])}r.bindRenderbuffer(r.RENDERBUFFER,null),L.depthBuffer&&(Y.__webglDepthRenderbuffer=r.createRenderbuffer(),ft(Y.__webglDepthRenderbuffer,L,!0)),e.bindFramebuffer(r.FRAMEBUFFER,null)}}if(tt){e.bindTexture(r.TEXTURE_CUBE_MAP,$.__webglTexture),lt(r.TEXTURE_CUBE_MAP,b);for(let at=0;at<6;at++)if(b.mipmaps&&b.mipmaps.length>0)for(let st=0;st<b.mipmaps.length;st++)Z(Y.__webglFramebuffer[at][st],L,b,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+at,st);else Z(Y.__webglFramebuffer[at],L,b,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+at,0);p(b)&&m(r.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(_t){for(let at=0,st=Q.length;at<st;at++){const Ct=Q[at],it=n.get(Ct);e.bindTexture(r.TEXTURE_2D,it.__webglTexture),lt(r.TEXTURE_2D,Ct),Z(Y.__webglFramebuffer,L,Ct,r.COLOR_ATTACHMENT0+at,r.TEXTURE_2D,0),p(Ct)&&m(r.TEXTURE_2D)}e.unbindTexture()}else{let at=r.TEXTURE_2D;if((L.isWebGL3DRenderTarget||L.isWebGLArrayRenderTarget)&&(at=L.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),e.bindTexture(at,$.__webglTexture),lt(at,b),b.mipmaps&&b.mipmaps.length>0)for(let st=0;st<b.mipmaps.length;st++)Z(Y.__webglFramebuffer[st],L,b,r.COLOR_ATTACHMENT0,at,st);else Z(Y.__webglFramebuffer,L,b,r.COLOR_ATTACHMENT0,at,0);p(b)&&m(at),e.unbindTexture()}L.depthBuffer&&Nt(L)}function N(L){const b=L.textures;for(let Y=0,$=b.length;Y<$;Y++){const Q=b[Y];if(p(Q)){const tt=L.isWebGLCubeRenderTarget?r.TEXTURE_CUBE_MAP:r.TEXTURE_2D,_t=n.get(Q).__webglTexture;e.bindTexture(tt,_t),m(tt),e.unbindTexture()}}}const Ht=[],zt=[];function Zt(L){if(L.samples>0){if(Gt(L)===!1){const b=L.textures,Y=L.width,$=L.height;let Q=r.COLOR_BUFFER_BIT;const tt=L.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,_t=n.get(L),at=b.length>1;if(at)for(let st=0;st<b.length;st++)e.bindFramebuffer(r.FRAMEBUFFER,_t.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+st,r.RENDERBUFFER,null),e.bindFramebuffer(r.FRAMEBUFFER,_t.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+st,r.TEXTURE_2D,null,0);e.bindFramebuffer(r.READ_FRAMEBUFFER,_t.__webglMultisampledFramebuffer),e.bindFramebuffer(r.DRAW_FRAMEBUFFER,_t.__webglFramebuffer);for(let st=0;st<b.length;st++){if(L.resolveDepthBuffer&&(L.depthBuffer&&(Q|=r.DEPTH_BUFFER_BIT),L.stencilBuffer&&L.resolveStencilBuffer&&(Q|=r.STENCIL_BUFFER_BIT)),at){r.framebufferRenderbuffer(r.READ_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.RENDERBUFFER,_t.__webglColorRenderbuffer[st]);const Ct=n.get(b[st]).__webglTexture;r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,Ct,0)}r.blitFramebuffer(0,0,Y,$,0,0,Y,$,Q,r.NEAREST),l===!0&&(Ht.length=0,zt.length=0,Ht.push(r.COLOR_ATTACHMENT0+st),L.depthBuffer&&L.resolveDepthBuffer===!1&&(Ht.push(tt),zt.push(tt),r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,zt)),r.invalidateFramebuffer(r.READ_FRAMEBUFFER,Ht))}if(e.bindFramebuffer(r.READ_FRAMEBUFFER,null),e.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),at)for(let st=0;st<b.length;st++){e.bindFramebuffer(r.FRAMEBUFFER,_t.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+st,r.RENDERBUFFER,_t.__webglColorRenderbuffer[st]);const Ct=n.get(b[st]).__webglTexture;e.bindFramebuffer(r.FRAMEBUFFER,_t.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+st,r.TEXTURE_2D,Ct,0)}e.bindFramebuffer(r.DRAW_FRAMEBUFFER,_t.__webglMultisampledFramebuffer)}else if(L.depthBuffer&&L.resolveDepthBuffer===!1&&l){const b=L.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,[b])}}}function xt(L){return Math.min(i.maxSamples,L.samples)}function Gt(L){const b=n.get(L);return L.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&b.__useRenderToTexture!==!1}function Ot(L){const b=a.render.frame;u.get(L)!==b&&(u.set(L,b),L.update())}function Rt(L,b){const Y=L.colorSpace,$=L.format,Q=L.type;return L.isCompressedTexture===!0||L.isVideoTexture===!0||Y!==hi&&Y!==Fn&&(qt.getTransfer(Y)===Jt?($!==yn||Q!==ai)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",Y)),b}function te(L){return typeof HTMLImageElement<"u"&&L instanceof HTMLImageElement?(c.width=L.naturalWidth||L.width,c.height=L.naturalHeight||L.height):typeof VideoFrame<"u"&&L instanceof VideoFrame?(c.width=L.displayWidth,c.height=L.displayHeight):(c.width=L.width,c.height=L.height),c}this.allocateTextureUnit=I,this.resetTextureUnits=C,this.setTexture2D=U,this.setTexture2DArray=k,this.setTexture3D=O,this.setTextureCube=X,this.rebindTextures=wt,this.setupRenderTarget=kt,this.updateRenderTargetMipmap=N,this.updateMultisampleRenderTarget=Zt,this.setupDepthRenderbuffer=Nt,this.setupFrameBufferTexture=Z,this.useMultisampledRTT=Gt}function Hg(r,t){function e(n,i=Fn){let s;const a=qt.getTransfer(i);if(n===ai)return r.UNSIGNED_BYTE;if(n===au)return r.UNSIGNED_SHORT_4_4_4_4;if(n===ou)return r.UNSIGNED_SHORT_5_5_5_1;if(n===Ef)return r.UNSIGNED_INT_5_9_9_9_REV;if(n===Sf)return r.BYTE;if(n===yf)return r.SHORT;if(n===Us)return r.UNSIGNED_SHORT;if(n===su)return r.INT;if(n===_r)return r.UNSIGNED_INT;if(n===Zn)return r.FLOAT;if(n===Zs)return r.HALF_FLOAT;if(n===Tf)return r.ALPHA;if(n===bf)return r.RGB;if(n===yn)return r.RGBA;if(n===Af)return r.LUMINANCE;if(n===wf)return r.LUMINANCE_ALPHA;if(n===cr)return r.DEPTH_COMPONENT;if(n===vr)return r.DEPTH_STENCIL;if(n===Rf)return r.RED;if(n===lu)return r.RED_INTEGER;if(n===Cf)return r.RG;if(n===cu)return r.RG_INTEGER;if(n===uu)return r.RGBA_INTEGER;if(n===ca||n===ua||n===ha||n===fa)if(a===Jt)if(s=t.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===ca)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===ua)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===ha)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===fa)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=t.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===ca)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===ua)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===ha)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===fa)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===al||n===ol||n===ll||n===cl)if(s=t.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===al)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===ol)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===ll)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===cl)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===ul||n===hl||n===fl)if(s=t.get("WEBGL_compressed_texture_etc"),s!==null){if(n===ul||n===hl)return a===Jt?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===fl)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===dl||n===pl||n===ml||n===_l||n===gl||n===vl||n===xl||n===Ml||n===Sl||n===yl||n===El||n===Tl||n===bl||n===Al)if(s=t.get("WEBGL_compressed_texture_astc"),s!==null){if(n===dl)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===pl)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===ml)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===_l)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===gl)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===vl)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===xl)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Ml)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Sl)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===yl)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===El)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Tl)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===bl)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Al)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===da||n===wl||n===Rl)if(s=t.get("EXT_texture_compression_bptc"),s!==null){if(n===da)return a===Jt?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===wl)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Rl)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Pf||n===Cl||n===Pl||n===Ll)if(s=t.get("EXT_texture_compression_rgtc"),s!==null){if(n===da)return s.COMPRESSED_RED_RGTC1_EXT;if(n===Cl)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Pl)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Ll)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===gr?r.UNSIGNED_INT_24_8:r[n]!==void 0?r[n]:null}return{convert:e}}class Gg extends an{constructor(t=[]){super(),this.isArrayCamera=!0,this.cameras=t}}class Mn extends ye{constructor(){super(),this.isGroup=!0,this.type="Group"}}const Vg={type:"move"};class za{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Mn,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Mn,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new F,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new F),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Mn,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new F,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new F),this._grip}dispatchEvent(t){return this._targetRay!==null&&this._targetRay.dispatchEvent(t),this._grip!==null&&this._grip.dispatchEvent(t),this._hand!==null&&this._hand.dispatchEvent(t),this}connect(t){if(t&&t.hand){const e=this._hand;if(e)for(const n of t.hand.values())this._getHandJoint(e,n)}return this.dispatchEvent({type:"connected",data:t}),this}disconnect(t){return this.dispatchEvent({type:"disconnected",data:t}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(t,e,n){let i=null,s=null,a=null;const o=this._targetRay,l=this._grip,c=this._hand;if(t&&e.session.visibilityState!=="visible-blurred"){if(c&&t.hand){a=!0;for(const _ of t.hand.values()){const p=e.getJointPose(_,n),m=this._getHandJoint(c,_);p!==null&&(m.matrix.fromArray(p.transform.matrix),m.matrix.decompose(m.position,m.rotation,m.scale),m.matrixWorldNeedsUpdate=!0,m.jointRadius=p.radius),m.visible=p!==null}const u=c.joints["index-finger-tip"],h=c.joints["thumb-tip"],f=u.position.distanceTo(h.position),d=.02,g=.005;c.inputState.pinching&&f>d+g?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:t.handedness,target:this})):!c.inputState.pinching&&f<=d-g&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:t.handedness,target:this}))}else l!==null&&t.gripSpace&&(s=e.getPose(t.gripSpace,n),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));o!==null&&(i=e.getPose(t.targetRaySpace,n),i===null&&s!==null&&(i=s),i!==null&&(o.matrix.fromArray(i.transform.matrix),o.matrix.decompose(o.position,o.rotation,o.scale),o.matrixWorldNeedsUpdate=!0,i.linearVelocity?(o.hasLinearVelocity=!0,o.linearVelocity.copy(i.linearVelocity)):o.hasLinearVelocity=!1,i.angularVelocity?(o.hasAngularVelocity=!0,o.angularVelocity.copy(i.angularVelocity)):o.hasAngularVelocity=!1,this.dispatchEvent(Vg)))}return o!==null&&(o.visible=i!==null),l!==null&&(l.visible=s!==null),c!==null&&(c.visible=a!==null),this}_getHandJoint(t,e){if(t.joints[e.jointName]===void 0){const n=new Mn;n.matrixAutoUpdate=!1,n.visible=!1,t.joints[e.jointName]=n,t.add(n)}return t.joints[e.jointName]}}const Wg=`
void main() {
